...
export const LATTICE_REPOSITORIES_FALLBACK: LatticeRepository[] = [
  ...
  },
  {
    ...
    label: 'Infinite Octaves · Digits Master',
    url: 'https://github.com/FractiAI/synthobs-99-octave-digits-master',
    startingRef: 'main',
    blurb: 'Standalone SynthOBS digits master suite (Infinite Octaves engine shelf).',
  ...
  },
  {
    ...
    label: 'Infinite Octaves · Morphogenesis',
    url: 'https://github.com/FractiAI/synthobs-constructive-morphogenesis-99-octave',
    startingRef: 'main',
    blurb: 'Constructive morphogenesis through the Infinite Octaves lens.',
    tags: ['99-octave', 'synthobs'],
    guestSelectable: true,
  },
  {
    ...
    label: 'Infinite Octaves · Macro-Seismic',
  ...
  },
  {
    ...
    label: 'Infinite Octaves · Subterranean',
  ...
  },
  {
    ...
    label: 'Infinite Octaves · Metamorphic Invariant',
  ...
  },
  {
    ...
    label: 'Infinite Octaves · Planetary Core Goldilocks',
