  ...
  return (
    <div className="modal-root" role="dialog" aria-modal="true">
      ...
      <div className="voxel-panel modal-card">
        <h2 className="modal-title">{isTab ? 'Bridge Handoff' : 'Vessel Switch Detected'}</h2>
        <p className="modal-body">
          {isTab
            ? 'Another bridge tab took stream priority. Frequency stays single-threaded — no split signal.'
