...
export const MACHOTE_CAMPAIGN_COVER_ALT =
  "Valet Pru's Valet & Concierge Service · Downtown Reno — Art Deco poster, e-scooter powered personal valet";
...
export const MACHOTE_ROOM_SERVICE_TITLE = "Valet Pru's Valet & Concierge Service · Downtown Reno";
...
export const MACHOTE_ROOM_SERVICE_CAMPAIGN_BLURB =
  "Practical help first. Adventure second. Valet Pru's Valet & Concierge Service · Downtown Reno is part of the larger SS Vibelandia QuestFest vision.";
...
export const MACHOTE_BOOK_MAIL =
  "mailto:valetpru@gmail.com?subject=Valet%20Pru%27s%20Valet%20%26%20Concierge%20Service%20%C2%B7%20Downtown%20Reno%20%E2%80%94%20book%20now&body=Name%3A%0ANeighborhood%3A%0AWhat%20I%20need%3A%0APreferred%20time%3A";
...
export const MACHOTE_CAMPAIGN_TITLE = "Valet Pru's Valet & Concierge Service · Downtown Reno";
