...
export const SONIC_SINGULARITY_DESCRIPTION =
  'Holographic Reno swamp beats caliente — the Hydrogen Line, the fractal constant (φ), and the Y-frontiersmen Machote Modernos in one living frequency. Hero Jo\'s Golden Bachdoor Hit Factory holds the conductor rail; this catalog is the full sound on your device.';

/** One-line tag for playlist cards / sidebar hint row. */
export const SONIC_SINGULARITY_TAGLINE =
  'Reno swamp vibe · Hydrogen Line · φ · Machote Moderno Y-frontiersmen · Wrong Side truth';
