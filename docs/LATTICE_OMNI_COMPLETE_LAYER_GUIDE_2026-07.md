...
**Catalog sync:** 2026-08-08 · **51** Lattice Chat / Omni-Lattice family papers · generator `npm run sync:lattice-guide`
...
_Living table · 51 papers · regenerated by `npm run sync:lattice-guide` from `WHITEPAPER_REGISTRY`._
