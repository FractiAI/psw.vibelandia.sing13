...
**Catalog sync:** 2026-08-13 · **62** Lattice Chat Agent / Omni-Lattice family papers · generator `npm run sync:lattice-guide`
...
_Living table · 62 papers · regenerated by `npm run sync:lattice-guide` from `WHITEPAPER_REGISTRY`._
