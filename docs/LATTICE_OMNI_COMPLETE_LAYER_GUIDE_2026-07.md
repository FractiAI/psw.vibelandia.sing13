...
**Catalog sync:** 2026-08-08 · **50** Lattice Chat / Omni-Lattice family papers · generator `npm run sync:lattice-guide`
...
_Living table · 50 papers · regenerated by `npm run sync:lattice-guide` from `WHITEPAPER_REGISTRY`._
