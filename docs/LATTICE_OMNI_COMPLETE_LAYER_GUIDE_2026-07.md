...
**Catalog sync:** 2026-07-31 · **30** Lattice Chat / Omni-Lattice family papers · generator `npm run sync:lattice-guide`
...
_Living table · 30 papers · regenerated by `npm run sync:lattice-guide` from `WHITEPAPER_REGISTRY`._
