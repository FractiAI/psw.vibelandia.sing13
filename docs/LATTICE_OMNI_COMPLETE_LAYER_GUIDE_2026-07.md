...
**Catalog sync:** 2026-08-03 · **42** Lattice Chat / Omni-Lattice family papers · generator `npm run sync:lattice-guide`
...
_Living table · 42 papers · regenerated by `npm run sync:lattice-guide` from `WHITEPAPER_REGISTRY`._
