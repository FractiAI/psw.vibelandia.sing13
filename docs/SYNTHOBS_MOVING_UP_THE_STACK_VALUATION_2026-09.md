...
| Surface | Path |
|---------|------|
| Ship blog (plain speak) | `/ship-blog/moving-up-the-stack` |
| Lattice vs vibe receipts | `/ship-blog/lattice-vs-vibe-coding` |
| Gateway companion | `/ship-blog/pdvsa-gateway-ops-mockup` |
| Frontier trail | `/frontier` · `/ship-blog/what-it-means-to-be-frontier` |
| Lattice Chat | `/lattice` |
| Reading Room | `/papers` |
...
1. Companion receipts: [`docs/SYNTHOBS_LATTICE_VS_VIBE_CODING_DESIGN_WRITE_DEPLOY_2026-09.md`](./SYNTHOBS_LATTICE_VS_VIBE_CODING_DESIGN_WRITE_DEPLOY_2026-09.md) · `/ship-blog/lattice-vs-vibe-coding`
2. Gateway companion: [`docs/SYNTHOBS_PDVSA_GATEWAY_OPS_MOCKUP_2026-09.md`](./SYNTHOBS_PDVSA_GATEWAY_OPS_MOCKUP_2026-09.md) · `/ship-blog/pdvsa-gateway-ops-mockup`
3. Frontier trail: [`docs/SYNTHOBS_WHAT_IT_MEANS_TO_BE_FRONTIER_HOLOGRAPHIC_TRAIL_2026-09.md`](./SYNTHOBS_WHAT_IT_MEANS_TO_BE_FRONTIER_HOLOGRAPHIC_TRAIL_2026-09.md) · `/frontier`
4. Token-reduction spine (repo): Lattice Chat nested-agent envelopes under `lib/` + `/lattice`
