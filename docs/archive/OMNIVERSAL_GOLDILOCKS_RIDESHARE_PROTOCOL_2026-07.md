...
**Executed vs proposed:** E1–E5 are **completed** reproducible tests in `research/omniversal-goldilocks-rideshare/`. Optional operator field logs use `data/field_trial_template.json` — **not required** for pipeline pass. See [Coherence plain speak](../operations/COHERENCE_PLAIN_SPEAK_HONESTY_2026-05-18.md).
...
5. FractiAI Research Group. [Coherence · plain speak](../operations/COHERENCE_PLAIN_SPEAK_HONESTY_2026-05-18.md).
