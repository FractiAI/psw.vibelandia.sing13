...
**Companion:** [Goldilocks Game Mathematics · Erdős 344](GOLDILOCKS_GAME_MATHEMATICS_ERDOS_344_2026-05-26.md) · `research/goldilocks-math/src/goldilocks_master_engine.py`
...
This is **systemic epistemic validation** — the repo can replay the transform and inspect outputs. Cross-reference the [Coherence · plain speak](../fractiai/COHERENCE_PLAIN_SPEAK_HONESTY_2026-05-18.md) honesty boundary when communicating outside the sandbox.
