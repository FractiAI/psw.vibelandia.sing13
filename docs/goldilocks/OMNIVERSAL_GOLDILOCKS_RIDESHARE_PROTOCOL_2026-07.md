...
**Executed vs proposed:** E1–E5 are **completed** reproducible tests in `research/omniversal-goldilocks-rideshare/`. Optional operator field logs use `data/field_trial_template.json` — **not required** for pipeline pass. See [Coherence plain speak](../fractiai/COHERENCE_PLAIN_SPEAK_HONESTY_2026-05-18.md).
...
4. SynthOBS Autonomous Agent. [NSPFRNP Snap Peer-Review Audit](../whitepapers/NSPFRNP_SNAP_PEER_REVIEW_AUDIT_2026-06.md) · `NSPFRNP-SNAP-PRA-2026-06`.
5. FractiAI Research Group. [Coherence · plain speak](../fractiai/COHERENCE_PLAIN_SPEAK_HONESTY_2026-05-18.md).
