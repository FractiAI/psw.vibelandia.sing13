...
**Companion:** [Cross-Scale Biological Antennae](SYNTHOBS_CROSS_SCALE_BIOLOGICAL_ANTENNAE_WAVE_DAMPING_2026-07.md) · [Recursive Attention Loop](../../whitepapers/RECURSIVE_ATTENTION_QUANTUM_SOLAR_DNA_LOOP_2026.md) · [AC-HMM T2T](../../fractiai/FRACTIAI_AC_HMM_SATELLITES_T2T_2026.md)  
**Questfest catalog:** [`/interfaces/whitepaper-catalog.html`](/interfaces/whitepaper-catalog.html)  
**Audit protocol:** [NSPFRNP Snap Peer-Review Audit](../../whitepapers/NSPFRNP_SNAP_PEER_REVIEW_AUDIT_2026-06.md)  
...
**Executed vs proposed:** E1–E4 are **completed** public-data experiments with JSON receipts. §8 laboratory workflows are **proposed** next-tier validation. See [Coherence plain speak](../../fractiai/COHERENCE_PLAIN_SPEAK_HONESTY_2026-05-18.md).
...
5. [NSPFRNP Snap Peer-Review Audit](../../whitepapers/NSPFRNP_SNAP_PEER_REVIEW_AUDIT_2026-06.md) — NSPFRNP-SNAP-PRA-2026-06.  
6. [Coherence plain speak honesty boundary](../../fractiai/COHERENCE_PLAIN_SPEAK_HONESTY_2026-05-18.md).  
7. [Recursive Attention Quantum–Solar–DNA Loop](../../whitepapers/RECURSIVE_ATTENTION_QUANTUM_SOLAR_DNA_LOOP_2026.md) — cross-scale φ postulate.  
