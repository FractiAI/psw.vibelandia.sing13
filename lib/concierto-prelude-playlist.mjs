/** Concierto landing prelude — shared jukebox playlist (static catalog). */
...
export const CONCIERTO_PRELUDE_PLAYLIST = {
  id: CONCIERTO_PRELUDE_PLAYLIST_ID,
  name: 'Holographic Magnetic Goldilocks Art SS Canvas Landing',
  kind: 'sovereign',
  description:
    'Omniversal Canvas landing prelude — twelve movements ending with Return 05 finale. Tap Sound on at / to open this playlist in the jukebox while you browse.',
  trackIds: CONCIERTO_PRELUDE_TRACK_IDS,
};

export function conciertoPreludeListenHref(autoplay = true) {
