...
function whyCareLead(id) {
  if (id === 'synthobs-what-it-means-to-be-frontier-2026-09') {
    return (
      ...
      `Today’s tip pairs the EGS Lattice-Linear Gateway (PDVSA ops mock) with moving up the stack ` +
      `(Lattice vs vibe-coding receipts). Then play the <a href="/frontier">Frontier trail</a> — self-test + Where Am I on the QUESTFEST board. ` +
  ...
  if (id === 'synthobs-pdvsa-gateway-ops-mockup-2026-09') {
    return (
      `<a href="/frontier">Frontier</a> CEOs: start with Executive Papers. ` +
      `Today’s tip is the EGS Lattice-Linear Gateway (PDVSA ops mock) plus moving up the stack ` +
      `(Lattice vs vibe-coding receipts). Nine clickable takeaways into the papers and math — simulator, not live oilfield SLAs.`
    );
  }
  if (id === 'synthobs-lattice-vs-vibe-coding-2026-09') {
    return (
      `<a href="/frontier">Frontier</a> CEOs: start with Executive Papers. ` +
      `Today’s tip is moving up the stack — Lattice vs vibe-coding design/write/deploy receipts — ` +
      `paired with the EGS Lattice-Linear Gateway mock. Committed diffs, not slideware.`
    );
  }
