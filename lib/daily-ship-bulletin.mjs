...
function whyCareLead(id) {
  ...
  if (id === 'synthobs-prime-vault-alphafold-race-2026-09') {
    return (
      `Race day — today’s tip is <a href="/ship-blog/prime-vault-alphafold-race">Prime-Vault vs AlphaFold</a>: ` +
      `three tiers (Ubiquitin · IL-2 complex · orphan/synthetic) scoring accuracy · latency · resources under Φ ≈ 1.618. ` +
      `Catalog fixtures, not live AF API or CASP medal transfer. Fair Exchange tip clause on.`
    );
  }
