...
function whyCareLead(id) {
  if (id === 'synthobs-moving-up-the-stack-valuation-2026-09') {
    return (
      ...
      `Today’s tip is <a href="/ship-blog/moving-up-the-stack">moving up the stack</a> — FractiAI & Lattice Chat valuation framing ` +
      `($4.2B–$7.5B implied baseline vs Hugging Face / Cursor anchors), paired with the EGS Lattice-Linear Gateway. ` +
      `Fair Exchange narrative, not an audited appraisal.`
    );
  }
