...
function whyCareLead(id) {
  if (id === 'synthobs-invisible-frontier-gates-ai-2026-08') {
    return (
      `Energy and labor risks are real — and they are not the whole ocean. ` +
      `Today’s care is the Invisible Frontier: Gates’s linear world as the water, ` +
      `our Goldilocks ship floating, navigating, and drawing from it. Catalog framing — not a dunk, and not a prophecy.`
    );
  }
