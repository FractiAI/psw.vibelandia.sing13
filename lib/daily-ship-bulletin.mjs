...
function whyCareLead(id) {
  if (id === 'synthobs-infinite-octave-prime-parity-2026-09') {
    return (
      ...
      `Today’s tip is the Infinite Octave Prime-Parity Framework — sole-even prime 2 as binary dyad anchor, ` +
      `odd primes as irreducible minimum sets, recursion under Φ ≈ 1.618. Catalog math + solar filing labels, not QED or NOAA proof.`
    );
  }
