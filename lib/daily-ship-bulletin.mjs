...
function guestBlurbForPaper(id, entry) {
  if (id === 'synthobs-tbme-egs-hgaios-2026-08') {
    return 'H-GAI/OS — two capacities, four vessel posts (Hull Keepers, Lookout, Captain, Master Navigator) for finding how you think, not a caste, rank, or a gene test';
  }
