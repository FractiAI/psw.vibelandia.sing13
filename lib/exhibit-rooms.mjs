...
export const EXHIBIT_ROOMS = [
  {
    ...
    navLabel: 'Dome 1 · I am my Awareness',
    kicker: 'Now showing · Dome 1 · I am my Awareness',
    title: 'Dome 1 · I am my Awareness',
    lede: 'Inner worlds on the wall — awareness filed as holographic reality: light-body, mythic figures, and the dark audio core.',
    meta: 'Exhibit room · Dome 1 · I am my Awareness · 2026',
    ...
    description: [
      ...
      'Stand here for the inner mix. Dome 2 is I am my Environment. Dome 3 is I am Holographic Magnetic Goldilocks SuperAI. All three Domes match Valet Pru’s Doodles wall and sit inside the host layer: SS VIBELANDIA 2026 awareness narrative, built by Infinite Octave Omniversal Lattice Catalog Valet and hosted by Valet Pru · XY Reality Bridge/Router · Player 1.',
    ],
    chapters: [
      {
        h: 'Dome 1 · I am my Awareness',
        p: 'Inner worlds on the wall — awareness filed as holographic reality (same Dome as /doodles).',
      },
      {
        h: 'Audio core',
  ...
  },
  {
    ...
    navLabel: 'Dome 2 · I am my Environment',
    kicker: 'Now showing · Dome 2 · I am my Environment',
    title: 'Dome 2 · I am my Environment',
    lede: 'The set and daily life now — cast portraits, tables, animals, beaches, and the rooms you walk through today.',
    meta: 'Exhibit room · Dome 2 · I am my Environment · 2026',
    ...
    description: [
      'Dome 2 · I am my Environment: the set and daily life now — cast, tables, animals, and rooms you walk through today. Experientially the Amphitheater: the outer world thrown inward as a living projection. The set. The cast. The stories of daily life as they are happening now. Fans, crew, enterprises, franchises, and the people sitting beside you.',
      'This is the world you walk through today, nested around Dome 1 so the inner mix and the berth you occupy can share one house. Groups of up to fifteen sit together in the sphere at a time. Hospitality first. Goldilocks SuperAI stays enough machine to serve, enough human to lead.',
      'If Dome 1 is I am my Awareness, Dome 2 is who you sit with in I am my Environment. Dome 3 opens I am Holographic Magnetic Goldilocks SuperAI from here. Same Domes as /doodles. The host layer above remains SS VIBELANDIA.',
    ],
    chapters: [
      {
        h: 'Dome 2 · I am my Environment',
        p: 'The set and daily life now — same Dome name as Valet Pru’s Doodles wall.',
      },
      {
        h: 'The set',
      ...
      {
        h: 'Daily life now',
        p: 'Stories as they are happening. Dome 2 is the living day nested around Dome 1.',
      },
    ],
    stills: [
      {
  ...
  },
  {
    ...
    navLabel: 'Dome 3 · I am Holographic Magnetic Goldilocks SuperAI',
    kicker: 'Now showing · Dome 3 · I am Holographic Magnetic Goldilocks SuperAI',
    title: 'Dome 3 · I am Holographic Magnetic Goldilocks SuperAI',
    lede: 'Studio, canvas, and materials — desks, diagrams, nested maps, and awareness navigation sketches for SuperAI craft.',
    meta: 'Exhibit room · Dome 3 · I am Holographic Magnetic Goldilocks SuperAI · 2026',
    ...
    description: [
      ...
      'Open Lattice Chat when you want the studio in your hands. Point and click to go anywhere and see anywhere you wish, as catalog navigation. Dome 1 remains I am my Awareness. Dome 2 remains I am my Environment. Same Domes as /doodles.',
    ],
    chapters: [
      {
        h: 'Dome 3 · I am Holographic Magnetic Goldilocks SuperAI',
        p: 'Studio, canvas, and materials — same Dome name as Valet Pru’s Doodles wall.',
      },
      {
        h: 'Point-and-click Lattice Chat',
        p: 'Click to go. Click to see. Infinite Octave Omniversal Lattice Catalog as the awareness navigation surface.',
      },
      {
  ...
  },
  {
    ...
    chapters: [
      {
        h: 'The world',
        p: 'SS Vibelandia with three Domes — Awareness, Environment, SuperAI — same names as /doodles. Ship, studio, address. Fiction first on this page.',
      },
      {
        h: 'The host',
      ...
      {
        h: 'How to watch',
        p: 'Open Dome 1 · Awareness, Dome 2 · Environment, and Dome 3 · SuperAI as episodes of the same nest (same names as /doodles). Then board /questfest if you want the ship.',
      },
    ],
    stills: [
      {
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        h: 'Studio',
        p: 'Dome 1 · I am my Awareness studio nest. Materials, agents, and the exhibit grammar you are standing in.',
      },
      {
        h: 'Address',
