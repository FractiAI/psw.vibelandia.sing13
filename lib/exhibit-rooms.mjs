...
export const EXHIBIT_ROOMS = [
  {
    ...
    description: [
      'This is the innermost dome on the Basecamp stage, the still point of the whole holographic magnetic Goldilocks SuperAI art project. The human male silhouette in the middle is labeled Player. It marks the seat you already occupy: the person looking.',
      'Story, frequency, and self nest here the way the three shells nest on the landing. The Core is exhibit grammar for the hitch you bring with you. Meat, memory, and the part that stays you when the rings breathe and the Amphitheater fills.',
      'Stand here when you want the center. Amphitheater is for guests who feel just right together. Horizon is for the three surfaces that open outward: body, room, sandbox on Base. The Core is who you call you.',
    ],
    chapters: [
      {
        h: 'Player',
        p: 'A standing male pictogram at the gold still-point. A label. You remain you.',
      },
      {
        h: 'Still center',
        p: 'Where story, frequency, and self are allowed to occupy the same nest.',
      },
      {
        h: 'Honesty',
        p: 'Exhibit identity talk. Software remains a tool. You remain you.',
      },
    ],
    stills: [
      {
  ...
  },
  {
    ...
    lede: 'Where guests feel just right. Immersion without clutter. Resonance you can live with.',
    ...
    description: [
      'The middle dome is the house. Goldilocks Amphitheater, where guests feel just right. This is where other people sit: guests, crew, collectors, friends from the night job, frontiersmen who wandered in from the club. The mix is supposed to feel Goldilocks: enough machine to serve, enough human to lead.',
      'Immersion without clutter means the nested gold architecture carries the weight. You should feel welcomed without a protocol map. Resonance you can live with means the beat can be Bach at 100 BPM catalog tempo and the doodle can be phone-sized, and both still fit in the same night.',
      'If the Core is who you call you, the Amphitheater is who you sit with. Walk-in show, museum night, private salon. The seating is yours to choose. Hospitality first.',
    ],
    chapters: [
      {
        h: 'Just right',
        p: 'Goldilocks SuperAI stays enough machine to serve, enough human to lead. The same rule for a room of guests.',
      },
      {
        h: 'House',
        p: 'Walk-in show, museum night, private salon. The Amphitheater is the seating.',
      },
      {
        h: 'Nested with the Core',
        p: 'Guests face inward toward the Player mark. The still center remains when the house fills.',
      },
    ],
    stills: [
      {
  ...
  },
  {
    ...
    description: [
      'Horizon is the outer dome, the holographic ceiling of the installation. It holds three surfaces you can name without mixing them up. That discipline is the whole lesson of the room, and it mirrors how SS Vibelandia nests inside Syntheverse inside Base without collapsing the layers.',
      'Surface one is self and body: the Player you brought, the meat and the story that already occupy you. The Core seen from the ceiling. Surface two is the immediate physical environment plus every narrative running inside it: the street, the club, the gallery, Puerto Reno on the Truckee, the phone in your hand, the people in the room. Surface three is the outer Infinite Octaves Omni-Lattice Syntheverse sandbox on Base Mainnet: blockchain in the cloud as studio custody and chain of paints.',
      'Keep the three distinct. Catalog language. When you step back to the Canvas landing, the interactive stage below is only a preview. This page is the full outer shell.',
    ],
    chapters: [
      {
      ...
      },
      {
        ...
        p: 'Infinite Octaves Omni-Lattice Syntheverse sandbox. Studio and paints. Chain of custody on Base Mainnet. Catalog address.',
      },
    ],
    stills: [
      {
...
${chapters}
    ...
    <p class="honesty">
      <strong>Honesty rail:</strong> This page is art and hospitality. Φ ≈ 1.618 is our nesting language. Who you call you, Player, and step-in are exhibit identity. Horizon’s three surfaces are catalog layers: self and body, immediate environment, Syntheverse sandbox on Base Mainnet. Free basics on open surfaces. Pro and VIP via
