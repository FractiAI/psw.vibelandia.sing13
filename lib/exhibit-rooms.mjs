...
export const EXHIBIT_ROOMS = [
  {
    ...
    description: [
      ...
      'Stand here when you want the inner mix. Dome 2 is the set and daily life now. Dome 3 is the SuperAI Studio, Canvas, and Materials. All three sit inside Valet Pru as Human Bridge/Router, the gold museum framed entrance to SS VIBELANDIA.',
    ],
    chapters: [
      {
        h: 'Audio core',
  ...
  },
  {
    ...
    description: [
      ...
      'Human-to-human reality bridge/routers carry spin navigation: people routing attention for one another. Valet Pru is that Human Bridge/Router to SS VIBELANDIA, the outer label on the gold framed entrance.',
    ...
    chapters: [
      ...
      },
      {
        ...
        p: 'Human-to-human reality bridge/routers. Spin navigation. Valet Pru as the Human Bridge/Router. Catalog, not hardware teleport.',
      },
    ],
    stills: [
      {
