...
export function renderReadingRoomHeroHtml() {
  return renderExperiencePageHeroHtml({
    ...
    planeAlt: 'Safari club reading room — books, trophies, and keepsakes from past adventures',
    youtubeId: READING_ROOM_VIDEO_ID,
    videoTitle: 'Reading Room prelude video',
    brand: 'Deck 9 · Deep Memory · Safari Club',
    brandNote:
      'Sit in the man cave. Books, trophies, exotic keepsakes, and sacred objects from past adventures — <strong>old-school safari club class</strong>, fit for Roosevelt or von Humboldt.',
    title: 'Reading Room',
    lede: 'Read the map under the music. Full paper abstracts, honesty rails, and ship-blog notes — no heavy catalog chrome.',
