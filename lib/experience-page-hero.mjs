...
export function renderReadingRoomPreludeHtml() {
  return `<header class="rr-prelude" aria-label="Reading Room prelude video">
  ...
  <section class="rr-intro" aria-labelledby="rr-intro-h">
    ...
    <p class="rr-intro__lede">Browse poster art pulled from each paper's abstract focus — tap a cover to read the full paper.</p>
    <div class="rr-intro__cta">
      <a class="btn btn--gold" href="#papers">Browse papers</a>
      <a class="btn btn--ghost" href="/ship-blog/">Ship blog</a>
