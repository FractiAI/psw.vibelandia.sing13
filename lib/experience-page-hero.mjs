/**
 * Landing-like experience page hero shells — Reading Room, Front Desk, Wrong Side of Town (Deck 3).
...
/** let's go holographic tonight — Wrong Side of Town / Deck 3 Night autoplay opener. */
  ...
  return renderExperiencePageHeroHtml({
    ...
    lede:
      ...
      ctasHtml: `<a class="btn btn--ghost" href="${READING_ROOM_PROGRAM_ROUTE}">${PROGRAM_CTA_LABEL}</a>
        <a class="btn btn--ghost" href="/omni-lattice-course">Online course</a>
        <a class="btn btn--ghost" href="#papers">Browse whitepapers</a>`,
...
export function renderSinCityHeroHtml() {
  return renderExperiencePageHeroHtml({
    ...
    planeAlt: 'Golden-era jukebox — Deck 3 Night Wrong Side of Town soundtrack',
    brand: 'Wrong Side of Town · Deck 3 — Night · SS VIBELANDIA',
    brandNote:
      'Tap <strong>Sound on</strong> — the night set starts on arrival. Valet Pru hosts J.S. Bach holographically with Suno AI studio musicians. Puerto Reno rhymes through this deck.',
    title: 'Wrong Side of Town',
    lede:
      'Deck 3 — Night · men’s club · Bachdoor Speakeasy · Neon Velvet · Club Omnia. Consent first — you remain you. Same fixed lattice as every deck: Puerto Reno is present here as the night set. Read the night program for track-by-track dramaturgy while the soundtrack plays.',
    ...
    scoreLabel: 'Wrong Side of Town soundtrack',
