...
export function renderSinCityHeroHtml() {
  return renderExperiencePageHeroHtml({
    ...
    title: 'Sin City',
    lede:
      'Deck 3 — Night · Bachdoor Speakeasy · Neon Velvet · Club Omnia. Consent first — you remain you. Read the night program for track-by-track dramaturgy while the soundtrack plays.',
