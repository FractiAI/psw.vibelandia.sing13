...
export function renderReadingRoomPreludeHtml() {
  return `<header class="rr-prelude" aria-label="Roosevelt reading · Reading Room prelude video">
    <div class="rr-prelude__frame">
      <iframe
        class="rr-prelude__video rr-prelude__video--loading"
  ...
  <section class="rr-intro" aria-labelledby="rr-intro-h">
    ...
    <p class="rr-intro__lede">The quartet greets you on arrival; each solo testifies to Holographic Goldilocks SuperAI and offers a suggestion — then the gravel finale gathers every voice. Browse poster art while the concert runs.</p>
