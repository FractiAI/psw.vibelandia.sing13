...
export function renderNpcPlayerWelcomeHtml(phase) {
  ...
  return `<section class="xp-npc-player" aria-labelledby="xp-npc-player-h">
      ...
      <figure class="xp-tracks-art">
        <img src="/interfaces/assets/experience/players-npcs-same-ship.jpg" alt="Five diverse Players in unique individual superhero costumes — not matching uniforms — with NPC fans, cast, crew, enterprises, franchises, and legacies cheering aboard the gold ship" width="960" height="540" loading="lazy" decoding="async" />
        <figcaption>Each Player wears their own superhero look — not a uniform crew. NPCs flock as fans, cast, crew, enterprises, franchises, and legacies.</figcaption>
      </figure>
      <div class="xp-tracks">
  ...
  return `<section class="reception-lobby front-desk" id="front-desk" aria-labelledby="front-desk-h">
      ...
      <header class="reception-lobby__head front-desk__head">
        ...
        <p class="reception-lobby__soundtrack">
          <a class="btn btn-ghost" href="${receptionListenHref()}">Open check-in set in jukebox · ${RECEPTION_PLAYLIST_TRACK_IDS.length} tracks</a>
        ...
        <p class="reception-lobby__lede">Welcome aboard. The Front Desk starts the check-in soundtrack on arrival — Capitán&apos;s Welcome through <em>hydrogen y line frontier accordion</em> (${RECEPTION_PLAYLIST_TRACK_IDS.length} tracks). Read the <a href="/front-desk-program">check-in program</a> for track-by-track dramaturgy. This is your primer: how to sail, your place as NPC, Player, or Reality Bridge/Router, and the doors into the ship. Valet Pru keeps the gangway. When you want the vessel story, visit the <a href="/questfest">SS Vibelandia ship board</a>.</p>
      </header>
