...
export const EXPERIENCE_PHASES = [
  ...
  },
  {
    ...
    imageAlt: 'Several frontiersmen friends checking in together at the gold and navy Front Desk aboard SS Vibelandia',
  },
  {
    id: 'studio',
    number: 3,
...
export function renderFrontDeskLobbyHtml() {
  ...
  return `<section class="reception-lobby front-desk" id="front-desk" aria-labelledby="front-desk-h">
      ...
      <header class="reception-lobby__head">
        ...
        <h2 id="front-desk-h">Front Desk &amp; check-in</h2>
        <figure class="reception-lobby__art">
          <img src="/interfaces/assets/experience/reception-checkin-lobby.jpg" alt="Several frontiersmen friends checking in together at the gold and navy Front Desk aboard SS Vibelandia" width="960" height="540" loading="eager" decoding="async" />
