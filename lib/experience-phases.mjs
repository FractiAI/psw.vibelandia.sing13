...
export function renderNpcPlayerWelcomeHtml(phase) {
  ...
  return `<section class="xp-npc-player" aria-labelledby="xp-npc-player-h">
      ...
      <a class="xp-self-test" href="/coexist#self-test">
        <strong>Don’t know if you’re a Player or NPC? Click for a confidential self-test.</strong>
        <span>Voluntary. Scores stay on this device — nobody else sees them. Not hiring, not a census, not medical.</span>
      </a>
