...
export const EXPERIENCE_PHASES = [
  ...
  },
  {
    ...
    imageAlt: 'Several frontiersmen friends checking in together at the gold and navy reception lobby aboard SS Vibelandia',
  },
  {
    id: 'studio',
    number: 3,
  ...
  return `<section class="reception-lobby" id="reception-lobby" aria-labelledby="reception-h">
      ...
      <header class="reception-lobby__head">
        ...
        <figure class="reception-lobby__art">
          <img src="/interfaces/assets/experience/reception-checkin-lobby.jpg" alt="Several frontiersmen friends checking in together at the gold and navy reception lobby aboard SS Vibelandia" width="960" height="540" loading="eager" decoding="async" />
          <figcaption>Frontiersmen friends at check-in. Art deco Goldilocks lobby. Valet Pru keeps the desk.</figcaption>
        </figure>
        <p class="reception-lobby__soundtrack">
          <button
            type="button"
            class="btn btn-ghost reception-hero__score"
            id="reception-hero-score"
            hidden
            aria-pressed="false"
            aria-controls="reception-hero-audio"
            aria-label="Play reception soundtrack: Welcome Aboard"
