 ...
 * Phase 1: Omniversal Canvas (gold museum entry)
 * Phase 2: SS Vibelandia Reception Lobby (primer, mode, ship tour menu)
 * Phase 3: Creator Studio (doodle and build on holographic canvas)
...
export function renderPhaseRailHtml(currentPhaseId) {
  ...
  return `<nav class="xp-rail" aria-label="Visitor experience · three phases">
      <p class="xp-rail__kicker">Your visit · three phases</p>
...
export function renderReceptionLobbyHtml() {
  ...
  return `<section class="reception-lobby" id="reception-lobby" aria-labelledby="reception-h">
      ...
      <header class="reception-lobby__head">
        ...
        <p class="reception-lobby__lede">Welcome aboard. This is the primer, onboarding, and main menu for visitors and guests. Valet Pru keeps the gangway. Choose how you want to sail — then tour the decks, food and drink, library, shore excursions, and everything else the vessel offers.</p>
      </header>
...
export function renderCreatorPhaseHtml() {
  return `<div class="creator-phase" id="creator-phase">
      ...
      <header class="creator-phase__head">
        ...
        <p class="creator-phase__lede">You have walked the exhibit and checked in aboard the ship. Now the invitation: use the same canvas and materials Valet Pru built — nested domes, Syntheverse sandbox, Lattice Chat valet — to create your own work. Phone doodles welcome. Keys stay with you.</p>
      </header>
