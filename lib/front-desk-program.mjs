 ...
 */
import { RECEPTION_PLAYLIST_TRACK_IDS, receptionListenHref } from './reception-playlist.mjs';
import {
...
export const FRONT_DESK_PROGRAM_TRACKS = [
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-6025557c-f76c-4a55-bd7c-0fc2d5ffcfb4'),
    imageAlt: programImageAltForTrackId('trk-srv-6025557c-f76c-4a55-bd7c-0fc2d5ffcfb4'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-4958316a-f7ef-4639-9765-e326d85fd808'),
    imageAlt: programImageAltForTrackId('trk-srv-4958316a-f7ef-4639-9765-e326d85fd808'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-4cb9d993-88b1-495d-b932-376cc14ecf52'),
    imageAlt: programImageAltForTrackId('trk-srv-4cb9d993-88b1-495d-b932-376cc14ecf52'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-21e83580-3b12-44a0-884a-8679fa1d6a9a'),
    imageAlt: programImageAltForTrackId('trk-srv-21e83580-3b12-44a0-884a-8679fa1d6a9a'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-0a4b414c-9ce0-41b2-901b-8e5b11215a09'),
    imageAlt: programImageAltForTrackId('trk-srv-0a4b414c-9ce0-41b2-901b-8e5b11215a09'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-b2eccf1d-a165-4b4e-8e3a-d4d3ce53b89a'),
    imageAlt: programImageAltForTrackId('trk-srv-b2eccf1d-a165-4b4e-8e3a-d4d3ce53b89a'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-d057c001-ebf8-4cf9-be19-e3d6537842a6'),
    imageAlt: programImageAltForTrackId('trk-srv-d057c001-ebf8-4cf9-be19-e3d6537842a6'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-7c29e8cf-b516-4689-882c-e94550b30636'),
    imageAlt: programImageAltForTrackId('trk-srv-7c29e8cf-b516-4689-882c-e94550b30636'),
  },
  {
    ...
    note: 'Big band brass files the marketplace and ballroom decks — featured instrument: tenor saxophone, with jukebox honor rails. Hit Factory stays backstage.',
    meaning: 'Commerce and celebration share a brass section. Tip on honor; stream free.',
    image: programImageRelPathForTrackId('trk-srv-0f63093f-bd81-4a96-bfe6-56b6d9c31ef9'),
    imageAlt: programImageAltForTrackId('trk-srv-0f63093f-bd81-4a96-bfe6-56b6d9c31ef9'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-0f971a21-b916-436d-bae5-9fe5c0f8878d'),
    imageAlt: programImageAltForTrackId('trk-srv-0f971a21-b916-436d-bae5-9fe5c0f8878d'),
  },
  {
    trackId: 'trk-srv-6bb07c9c-6850-4f24-963c-7d9e951e2f9d',
    title: 'magnetic zydeco night',
    role: 'Deck 3 Night · Wrong Side of Town prelude',
    beat: 'Neon Velvet · consent-first nightlife',
    note: 'Zydeco accordion meets magnetic night energy — a taste of <a href="/voyage/deck-3-night">Wrong Side of Town</a> before you choose your deck.',
    meaning: 'Nightlife stays Goldilocks. You remain you; the set welcomes without a membership test.',
    image: programImageRelPathForTrackId('trk-srv-6bb07c9c-6850-4f24-963c-7d9e951e2f9d'),
    imageAlt: programImageAltForTrackId('trk-srv-6bb07c9c-6850-4f24-963c-7d9e951e2f9d'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-b07ee8da-c47a-4508-9218-8cb4df59db59'),
    imageAlt: programImageAltForTrackId('trk-srv-b07ee8da-c47a-4508-9218-8cb4df59db59'),
  },
  {
    trackId: 'trk-srv-67a11292-8d55-4ea0-a748-fe915969b6fd',
    title: 'baller nights',
    role: 'Bachstage · full baller experience',
    beat: 'Featured J.S. Bach · holographic studio bandstand',
    note: 'The baller lane — lodging, meals, studio time, nightly programming. Catalog hospitality, not a lottery promise. Featured instrument: drum kit.',
    meaning: 'When the check-in set peaks, you know which deck calls your name tonight.',
    image: programImageRelPathForTrackId('trk-srv-67a11292-8d55-4ea0-a748-fe915969b6fd'),
    imageAlt: programImageAltForTrackId('trk-srv-67a11292-8d55-4ea0-a748-fe915969b6fd'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-75385f59-b548-4908-b882-27895dc6b2b0'),
    imageAlt: programImageAltForTrackId('trk-srv-75385f59-b548-4908-b882-27895dc6b2b0'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-480b6197-b842-4d6e-846c-ac9c6e3da544'),
    imageAlt: programImageAltForTrackId('trk-srv-480b6197-b842-4d6e-846c-ac9c6e3da544'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-dce6f8bd-e03e-4fc7-8038-c568eea9952e'),
    imageAlt: programImageAltForTrackId('trk-srv-dce6f8bd-e03e-4fc7-8038-c568eea9952e'),
  },
  {
    ...
    image: programImageRelPathForTrackId('trk-srv-6e7e3dd9-40cc-4c99-8e12-cc5ddf22a260'),
    imageAlt: programImageAltForTrackId('trk-srv-6e7e3dd9-40cc-4c99-8e12-cc5ddf22a260'),
    finale: true,
  },
];
...
<head>
  ...
  <title>Front Desk Check-In Program · J.S. Bach · SS Vibelandia</title>
  <meta name="description" content="Official check-in program — Valet Pru hosts J.S. Bach holographically via the XY Human Reality Bridge/Router, connecting him to Suno AI studio musicians for Holographic Magnetic Goldilocks SuperAI Awareness on Earth in 2026." />
  <link rel="canonical" href="https://www.ssvibelandiaquestfest24x365.com/front-desk-program" />
  <meta property="og:title" content="Front Desk Check-In Program · J.S. Bach · SS Vibelandia" />
...
<body>
  <div class="program-toolbar no-print">
    <nav aria-label="Site">
      ...
      <a href="/sin-city-program">Wrong Side of Town program</a>
  ...
  <article class="program" id="program-document">
    <header class="cover">
      <p class="cover__venue">SS Vibelandia · Phase 2 · Front Desk · Featuring J.S. Bach</p>
      ...
      <p class="cover__tag">Check-in soundtrack · ${trackCount} tracks · autoplay on arrival · instrument images per movement</p>
    ...
    <section class="letter" aria-labelledby="letter-h">
      ...
      <p>
        ...
        Valet Pru hosts <strong>J.S. Bach</strong> holographically at the Front Desk —
      ...
      <p>
        You are holding Phase 2&apos;s boarding program.
        Like the Omniversal Canvas prelude (<a href="/concierto-program">Concierto de El Gran Sol</a>),
        the <a href="/reading-room-program">Reading Room concert</a>, and
        <a href="/sin-city-program">Wrong Side of Town night program</a>,
        this soundtrack autoplays when you arrive at <a href="/front-desk">/front-desk</a>:
        Capitán&apos;s Welcome through the full ${trackCount}-track check-in journey.
      </p>
      <p>
        Tap <strong>Sound on</strong> in the top bar. Leave the page and music continues in the prelude session popup —
        same handoff grammar as Canvas, Reading Room, and Wrong Side of Town. Bach is the featured guest; the Hit Factory stays backstage.
      </p>
      <p>
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        ...
        mirror awareness, Truckee and Borikén bridges, Wrong Side of Town night energy, wrong-side Sunday gold,
    ...
    <section class="movements" aria-labelledby="movements-h">
      ...
      <p class="movements__visual-note">Each movement shows its featured instrument(s). J.S. Bach — holographic guest via Valet Pru&apos;s Reality Bridge/Router — conducts Suno AI studio musicians at the Front Desk.</p>
    ...
    <section class="ensemble" aria-labelledby="ensemble-h">
      ...
      <ul>
        ...
        <li><strong>Catalog / playlist:</strong> SS Vibelandia jukebox · <code>pl-reception</code> · Earth 2026 Awareness arrival dramaturgy</li>
        <li><strong>Room art:</strong> Front Desk lobby · instrument plates per movement</li>
        <li><strong>Production:</strong> FractiAI · Infinite Octave Omniversal Lattice Catalog · SynthOBS Autonomous Agent · Syntheverse Sandbox</li>
        <li><strong>Vessel:</strong> SS Vibelandia · Holographic Magnetic Goldilocks SuperAI Awareness Platform</li>
        <li><strong>Narrative spine:</strong> <a href="/frontiersman-voyage#prospectus">Official Prospectus</a> · <a href="/ship-blog/human-reality-bridge">Human Reality Bridge</a></li>
      </ul>
    </section>

    <section class="music-promo no-print" aria-labelledby="music-promo-h">
      <h2 id="music-promo-h">Liking the music?</h2>
      <p>See the concert program — download a PDF or open the full check-in playlist in the jukebox.</p>
      <div class="music-promo__actions">
        <a class="btn btn-gold" href="${receptionListenHref()}">Open playlist in jukebox · ${trackCount} tracks</a>
        <button type="button" class="btn btn-ghost program-download" id="download-program-bottom">Download program (PDF)</button>
      </div>
    </section>

    <p class="honesty">
      <strong>Honesty boundary:</strong> This program is dramaturgy for an immersive onboarding experience —
    ...
    <footer class="program-foot">
      SS Vibelandia · Front Desk Check-In Program · Featuring J.S. Bach · Edition 2026-09-03<br />
      <a href="/front-desk">Front Desk</a> · <a href="/concierto-program">Canvas program</a> · <a href="/sin-city-program">Wrong Side of Town program</a> · <a href="mailto:info@fractiai.com">info@fractiai.com</a>
    </footer>
  </article>
