...
export const FRONT_DESK_PROGRAM_TRACKS = [
  ...
  },
  {
    ...
    meaning: 'Fair Exchange via the Purser closes the set. The gangway stays open. → ∞^∞',
  ...
  <article class="program" id="program-document">
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        ...
        baller nights, and a finale that names the Player gravity — <em>we are the dance that makes the music</em>.
      </p>
      <p>
    ...
    <footer class="program-foot">
      ...
      <a href="/front-desk">Front Desk</a> · <a href="/concierto-program">Canvas program</a> · <a href="mailto:info@fractiai.com">info@fractiai.com</a>
    </footer>
  </article>
