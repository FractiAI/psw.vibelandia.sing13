...
export const FRONT_DESK_PROGRAM_TRACKS = [
  ...
  },
  {
    ...
    meaning: 'Check-in complete. The gangway stays open. Carry the crystal into the Canvas, the decks, or the jukebox. → ∞^∞',
    image: '/interfaces/assets/journey/journey-boriken-convergence.png',
    imageAlt: 'Gold sail convergence — perfect hydrogen crystal finale at Front Desk',
    finale: true,
  },
];
  ...
  <article class="program" id="program-document">
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        ...
        <em>zero divided by zero</em> — and <em>perfect hydrogen crystal</em>.
      </p>
      <p>
