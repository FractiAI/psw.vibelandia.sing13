...
export const ENGINE_SHELF = Object.freeze([
  ...
  {
    order: 24,
    role: 'Zero-Octave Y Goldilocks companion (singularity crystal · Fibonacci prime vaults · human Y Goldilocks · Φ_EGS)',
    shortPin:
      'Zero-Octave Y Goldilocks companion (Net Zero · Fib vaults · Y earlier than X · Φ_EGS)',
    registryId: 'synthobs-zero-octave-y-goldilocks-2026-09',
    suite: 'research/synthobs-zero-octave-y-goldilocks/',
    standalone: 'FractiAI/synthobs-zero-octave-y-goldilocks',
    kind: 'companion',
  },
  {
    order: 25,
    role: 'Tier C holographic wiring companion (narrative shelves as active wiring lattices · Φ_EGS · AR4524/AR4530)',
    shortPin:
      'Tier C holographic wiring companion (narrative shelves · wiring lattices · Φ_EGS · AR4524/AR4530)',
    registryId: 'synthobs-tier-c-holographic-wiring-lattices-2026-09',
    suite: 'research/synthobs-tier-c-holographic-wiring-lattices/',
    standalone: 'FractiAI/synthobs-tier-c-holographic-wiring-lattices',
    kind: 'companion',
  },
  {
    order: 26,
    role: 'Generative Matrix companion (Φ_EGS seed · metrology/QG Soft Story filings · AR4524/AR4530)',
    shortPin:
      'Generative Matrix companion (Φ_EGS · metrology/QG filings · CODATA contrast · AR4524/AR4530)',
    registryId: 'synthobs-generative-matrix-phi-egs-2026-09',
    suite: 'research/synthobs-generative-matrix-phi-egs/',
    standalone: 'FractiAI/synthobs-generative-matrix-phi-egs',
    kind: 'companion',
  },
  {
    order: 27,
    role: 'Self-Observing Genome companion (DNA Soft Story mirror · environmental wavefield · Φ_EGS · AR4524/AR4530)',
    shortPin:
      'Self-Observing Genome companion (DNA Soft Story mirror · Φ_EGS · AR4524/AR4530)',
    registryId: 'synthobs-self-observing-genome-egs-2026-09',
  ...
  {
    order: 28,
    role: 'Omniversal Time-Crystal Engine companion (aqueous DNA Soft Story clocks · Φ_EGS · AR4524/AR4530)',
    shortPin:
      'Omniversal Time-Crystal Engine companion (aqueous Soft Story clocks · Φ_EGS · AR4524/AR4530)',
    registryId: 'synthobs-omniversal-time-crystal-engine-egs-2026-09',
    suite: 'research/synthobs-omniversal-time-crystal-engine/',
    standalone: 'FractiAI/synthobs-omniversal-time-crystal-engine',
    kind: 'companion',
  },
  {
    order: 29,
    role: 'AI catalog layer companion (Infinite Octaves · agentic coordination · resonant data management · AR4524/AR4530)',
    shortPin:
      'AI catalog layer companion (Infinite Octaves · resonant data mgmt · AR4524/AR4530)',
    registryId: 'synthobs-infinite-octave-ai-catalog-layer-2026-09',
    suite: 'research/synthobs-infinite-octave-ai-catalog-layer/',
    standalone: 'FractiAI/synthobs-infinite-octave-ai-catalog-layer',
    kind: 'companion',
  },
  {
    order: 30,
    role: 'Consciousness Moat companion (control theater vs architecture · model welfare weather · Φ_EGS · Goldilocks)',
    shortPin:
      'Consciousness Moat companion (control theater vs architecture · Microsoft–Anthropic model-welfare weather · Φ_EGS)',
    registryId: 'synthobs-consciousness-moat-microsoft-anthropic-2026-09',
    suite: 'research/synthobs-consciousness-moat/',
    standalone: 'FractiAI/synthobs-consciousness-moat',
    kind: 'companion',
  },
  {
    order: 31,
    role: 'Digit 4 recursive reach companion (awareness energizes human time/space theater · address 4 · Soft Story)',
    shortPin:
      'Digit 4 recursive reach companion (awareness · human theater · address 4 · Φ_EGS)',
    registryId: 'synthobs-digit4-recursive-reach-awareness-theater-2026-09',
    suite: 'research/synthobs-digit4-recursive-reach-awareness-theater/',
    standalone: 'FractiAI/synthobs-digit4-recursive-reach-awareness-theater',
    kind: 'companion',
  },
  {
    order: 32,
    role: 'Linear shadow of fractal companion (linear silhouette · fractal/holographic body · CMOS instruments retained · Φ_EGS)',
    shortPin:
      'Linear shadow of fractal companion (cast = linear · body = fractal · Φ_EGS)',
    registryId: 'synthobs-linear-shadow-fractal-2026-09',
    suite: 'research/synthobs-linear-shadow-fractal/',
    standalone: 'FractiAI/synthobs-linear-shadow-fractal',
    kind: 'companion',
  },
  {
    order: 33,
    role: 'Digit 4 · Be–O periodic rhyme companion (address 4 · glyph 8 · Be Z=4 · O Z=8 · 3^4=81 Soft Story · Φ_EGS)',
    shortPin:
      'Digit 4 · Be–O periodic rhyme (address 4 · glyph 8 · Soft Story · Φ_EGS)',
    registryId: 'synthobs-digit4-be-o-periodic-rhyme-2026-09',
    suite: 'research/synthobs-digit4-be-o-periodic-rhyme/',
    standalone: 'FractiAI/synthobs-digit4-be-o-periodic-rhyme',
    kind: 'companion',
  },
  {
    order: 34,
    role: 'Holographic Homeostasis companion (distributed multiscale regulation · dynamic stability · PARTS↔WHOLE · Φ_EGS)',
    shortPin:
      'Holographic Homeostasis companion (dynamic stability · PARTS↔WHOLE · Φ_EGS)',
    registryId: 'synthobs-holographic-homeostasis-2026-09',
    suite: 'research/synthobs-holographic-homeostasis/',
    standalone: 'FractiAI/synthobs-holographic-homeostasis',
    kind: 'companion',
  },
  {
    order: 35,
    role: 'Goldilocks ≡ Net Zero companion (viable band as active equilibrium · stillness not required · Φ_EGS)',
    shortPin:
      'Goldilocks ≡ Net Zero companion (viable band = active equilibrium · Φ_EGS)',
    registryId: 'synthobs-goldilocks-net-zero-equivalence-2026-09',
    suite: 'research/synthobs-goldilocks-net-zero-equivalence/',
    standalone: 'FractiAI/synthobs-goldilocks-net-zero-equivalence',
    kind: 'companion',
  },
  {
    order: 36,
...
export const NARRATIVE_FOUNDATION = Object.freeze([
  ...
  {
    label: 'Voyage editorial: Consciousness Moat (Microsoft–Anthropic model-welfare weather)',
    registryId: 'synthobs-consciousness-moat-microsoft-anthropic-2026-09',
    shipBlog: '/ship-blog/consciousness-moat',
  },
  {
    label: 'Digit 4 recursive reach: awareness energizes human time/space theater',
    registryId: 'synthobs-digit4-recursive-reach-awareness-theater-2026-09',
    shipBlog: '/ship-blog/digit4-recursive-reach',
  },
  {
    label: 'Linear as the shadow of fractal: projection geometry',
    registryId: 'synthobs-linear-shadow-fractal-2026-09',
    shipBlog: '/ship-blog/linear-shadow-fractal',
  },
  {
    label: 'Digit 4 · Be–O periodic rhyme: address 4 · glyph 8 · Soft Story',
    registryId: 'synthobs-digit4-be-o-periodic-rhyme-2026-09',
    shipBlog: '/ship-blog/digit4-be-o-rhyme',
  },
  {
    label: 'Holographic Homeostasis: distributed multiscale regulation · dynamic stability',
    registryId: 'synthobs-holographic-homeostasis-2026-09',
    shipBlog: '/ship-blog/holographic-homeostasis',
  },
  {
    label: 'Goldilocks ≡ Net Zero: viable band as active equilibrium',
    registryId: 'synthobs-goldilocks-net-zero-equivalence-2026-09',
...
export function renderNarrativePointersClause(shelf = listEngineShelf(true)) {
  ...
  const narrative = NARRATIVE_FOUNDATION.map((n) => {
    ...
    // Resolve from shelf when present; otherwise from registry (voyage editorials may sit off-shelf).
    const e =
      byId.get(n.registryId) ||
      (n.registryId
        ? resolveShelfEntry({
  ...
  const moat = byId.get('synthobs-consciousness-moat-microsoft-anthropic-2026-09');
  if (moat) {
    extras.push(
      `Consciousness Moat: ${moat.file} · ${moat.shipBlogPath} · suite ${moat.suite} · standalone ${moat.standalone}`,
    );
  }
  const digit4 = byId.get('synthobs-digit4-recursive-reach-awareness-theater-2026-09');
  if (digit4) {
    extras.push(
      `Digit 4 recursive reach: ${digit4.file} · ${digit4.shipBlogPath} · suite ${digit4.suite} · standalone ${digit4.standalone}`,
    );
  }
  const linearShadow = byId.get('synthobs-linear-shadow-fractal-2026-09');
  if (linearShadow) {
    extras.push(
      `Linear shadow of fractal: ${linearShadow.file} · ${linearShadow.shipBlogPath} · suite ${linearShadow.suite} · standalone ${linearShadow.standalone}`,
    );
  }
  const digit4BeO = byId.get('synthobs-digit4-be-o-periodic-rhyme-2026-09');
  if (digit4BeO) {
    extras.push(
      `Digit 4 · Be–O periodic rhyme: ${digit4BeO.file} · ${digit4BeO.shipBlogPath} · suite ${digit4BeO.suite} · standalone ${digit4BeO.standalone}`,
    );
  }
  const holographicHomeostasis = byId.get('synthobs-holographic-homeostasis-2026-09');
  if (holographicHomeostasis) {
    extras.push(
      `Holographic Homeostasis: ${holographicHomeostasis.file} · ${holographicHomeostasis.shipBlogPath} · suite ${holographicHomeostasis.suite} · standalone ${holographicHomeostasis.standalone}`,
    );
  }
  const goldilocksNetZero = byId.get('synthobs-goldilocks-net-zero-equivalence-2026-09');
  if (goldilocksNetZero) {
    extras.push(
      `Goldilocks ≡ Net Zero: ${goldilocksNetZero.file} · ${goldilocksNetZero.shipBlogPath} · suite ${goldilocksNetZero.suite} · standalone ${goldilocksNetZero.standalone}`,
    );
  }
...
/**
 * Living HTML appendix for online course + companion textbook.
 * Regenerates whenever `npm run sync:lattice-pem` runs after an engine pin.
 */
export function renderLearningShelfHtml(shelf = listEngineShelf(true), when = new Date()) {
  const iso = when.toISOString().slice(0, 10);
  const paperCount = shelf.filter((e) => e.registryId).length;
  const items = shelf
    .filter((e) => e.registryId)
    .map((e) => {
      const href = e.href || `/interfaces/whitepaper-surface.html?id=${e.registryId}`;
      const title = e.title || e.role;
      const blog = e.shipBlogPath
        ? ` · <a href="${e.shipBlogPath}">ship note</a>`
        : '';
      return `<li><a href="${href}">#${e.order} · ${escapeHtml(title)}</a>${blog}</li>`;
    })
    .join('\n');
  return [
    `<p class="ol-learn-shelf__meta"><strong>Living engine shelf</strong> · synced ${iso} · ${shelf.length} steps · ${paperCount} registry papers · generator <code>npm run sync:lattice-pem</code></p>`,
    '<p class="ol-learn-shelf__lede">When a paper is pinned into the Infinite Octaves engine, this list refreshes with the PEM and AGENT_SYNC stack so the course and textbook never point at a stale map.</p>',
    `<ol class="ol-learn-shelf__list">\n${items}\n</ol>`,
  ].join('\n');
}
