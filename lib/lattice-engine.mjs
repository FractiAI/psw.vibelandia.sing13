/**
 * Lattice Chat Agent V1.618 execution envelope — self-talk, agent roster, structural token estimate.
...
export function buildLatticeExecution(args) {
  ...
  return {
    engine: 'Lattice Chat Agent V1.618 · Nested Agent Lattice · Omni-Lattice',
    mode,
