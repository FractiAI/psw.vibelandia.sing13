/**
 * Lattice Chat V1.618 execution envelope — self-talk, agent roster, structural token estimate.
  ...
  return {
    ...
    assumptions: measured
      ...
      : [
          ...
          args.resumed
            ? 'Agent resume avoided re-sending full preamble'
            : 'Fresh agent included preamble once',
