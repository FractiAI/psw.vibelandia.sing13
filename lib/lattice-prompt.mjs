...
Parent synthesizes; peer-firewall on.${resumeNote}`;
  ...
  if (nest === 'octave99') {
    return `Nest: 99 OCTAVE LATTICE — Digits 0–9 × Octaves 01–99 under λ_EGS=Φ_EGS.
Engine pin: CMOS/protonic → tensor → master synthesis → digits master → Metamorphic Octave Invariant (Part XIII · shale→schist dual-axis heat/pressure).
