...
export const LATTICE_SKILLS_PILOT = Object.freeze({
  ...
  pinchChars: 1400,
  honesty:
    'FractiSkills full local corpus — SKILL.md packages generated from repo registries (papers, ship-blog, protocols, research, major interfaces) plus curated Lattice/Core meta skills. Pointer-first load only. Not a live public crawl, not a sixth cruise door, not a finished physics proof.',
});
