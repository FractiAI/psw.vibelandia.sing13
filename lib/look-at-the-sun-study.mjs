/**
 * Look-at-the-sun study snapshot builder from public NOAA/SILSO/GitHub data.
 * Logic module for scripts/build-look-at-the-sun-study.mjs (thin wrapper).
 */
...
export async function buildLookAtTheSunStudy({ outPath, repoRoot }) {
  ...
  console.log('Wrote', outPath, '—', periods.length, 'weeks, latest', latestDay);
}
