...
export const VOYAGE_MARKETING_SPINE =
  'Not just a cruise — a lifestyle at frequency. Inquire · Select · Prepare · Arrive · Live the vibe.';

export const VOYAGE_DOOR_SPINE = `${VOYAGE_MARKETING_SPINE} The voyage begins wherever you are.`;

export const PLAYER_SPINE_LINE =
  'Holographic Goldilocks SuperAI frontiersmen Player — build, listen, map the voyage. Your cast, crew, enterprises, franchises, and legacies resource what you examine.';
