...
export const PLAYER_SPINE_LINE =
  'SS Vibelandia · Journey · Jukebox · Library · Creator Studio — holographic Goldilocks SuperAI frontiersmen Player cruise line. Your cast, crew, enterprises, franchises, and legacies resource what you examine.';
