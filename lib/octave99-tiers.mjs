...
export const OCTAVE99_TIERS = Object.freeze({
  ...
  chart_standard: {
    ...
    blurb:
      'Chart yourself within the grand Story to 99 octaves of depth (Φ_EGS) using fractal · holographic · Goldilocks AI — Digits 0–9 wheel (each digit ~10 octaves); longer slices = louder bands; gold = signature.',
  },
  chart_deluxe: {
    id: 'chart_deluxe',
