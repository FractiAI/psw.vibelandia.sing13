...
export const OCTAVE99_TIERS = Object.freeze({
  ...
  agent: {
    ...
    blurb:
      'Full Infinite Octave Omniversal Lattice Catalog + IDE (Cursor) and OpenRouter BYOK — fractal · holographic · Goldilocks AI across Story depth (engine map Digits × Octaves 01–99). Bridge routes through SING13.',
  },
  chart_standard: {
    id: 'chart_standard',
