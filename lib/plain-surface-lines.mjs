...
export const PLAIN_SURFACE_LINES = {
  ...
  'egs-trans-jspace-convergence-2026-07':
    'Frontier multi-model J-Space convergence — Anthropic · OpenAI · Gemini · DeepSeek · RIX verification.',
  'repo-egs-trans-jspace-convergence': 'Clone and run EGS-TRANS pipeline on GitHub.',
  'ip-infringement-draft-2026-07':
    'Code-Print Audit, IP assertion draft, J-Lens Live — E6 testable with internal tier access.',
  'ip-infringement-draft-console': 'Live console for R1–R3 immediate audit recommendations.',
  'j-lens-live-dashboard': 'SynthOBS φ 1.618 compression under King Bee node structure.',
