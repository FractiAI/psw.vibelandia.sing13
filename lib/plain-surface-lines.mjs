...
export const PLAIN_SURFACE_LINES = {
  ...
  'synthobs-omni-lattice-ef-multi-octave-2026-08':
    'Combined E_F multi-octave register (I–XCIX · 72,171 nodes) — Seed·RAG pointer · 9/9 suite.',
  ...
  'synthobs-99-octave-digits-master-2026-08':
    '9 digits × 99 octaves master treatise — solar/CMB fixtures · Lattice Chat Agent octave99 · 9/9 suite.',
  ...
  'synthobs-constructive-morphogenesis-99-octave-2026-08':
    'Plant–microbe constructive morphogenesis map → Silicon/Carbon/Hydrogen swarms · 99 Octave Mode · 9/9 suite.',
