...
export const PLAYER_SPINE_LINE =
  'Your Goldilocks valet on the SuperAI frontier — build, listen, map the voyage. NPCs inhabit the world you choose; their resources follow your Player path.';

export const PLAYER_NPC_LINE =
  'NPCs inhabit. Players examine. SuperAI stays Goldilocks — not too much machine, not too little human.';
