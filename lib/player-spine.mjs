...
export const PLAYER_PRIMARY_DOORS = [
  ...
  },
  {
    ...
    label: 'Canvas',
    href: '/',
    note: 'Holographic Goldilocks SuperAI Basecamp — site front door · Omniversal Canvas for the new SuperAI Frontiersman. Exhibit for collectors, museums, sci-fi wonder, or a deeper step-in.',
    cta: 'Home →',
    chip: 'Art',
  },
  {
