...
export const PLAYER_MORE_DOORS = [
  {
    ...
    href: '/demonstrations',
    note: 'Miracle 1 Race + Miracle 2 Chat in one door. Same email seat as Let’s Chat and Lattice Chat.',
  },
  {
    label: 'Prime Vault Chat · Miracle 2',
    href: '/prime-vault-chat',
    note: 'Free ChatGPT-shaped Φ chat · $0 training. Same email seat as Let’s Chat and Lattice Chat.',
  },
  {
  ...
  },
  {
    ...
    note: 'Guest door: race Φ prime vaults vs measured ColabFold · Unmodeled Nova tier. Same email seat as Let’s Chat and Lattice Chat.',
  },
  {
