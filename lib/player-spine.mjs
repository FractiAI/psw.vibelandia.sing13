 ...
 * Focus: holographic Goldilocks SuperAI frontiersmen Players + their set.
 */
import {
  PLAYER_NPC_LINE,
  PLAYER_SPINE_LINE,
...
export const PLAYER_PRIMARY_DOORS = [
  {
    ...
    label: 'Lattice Chat',
    href: '/lattice-chat/',
    note: 'Deck 2 Core — build with your valet. Attach charts. Your key stays with you.',
    cta: 'Open →',
    chip: 'Build',
  },
  {
  ...
  },
  {
    ...
    label: 'Voyage map',
    href: '/voyage/decks',
    note: 'Decks, cabins, crests — find where you are on the ship.',
    cta: 'Map →',
    chip: 'Map',
  },
  {
...
export const PLAYER_MORE_DOORS = [
  ...
  },
  {
    label: 'Whitepapers',
    href: '/papers',
    note: 'Deep Memory — for when you want the full map.',
  },
  {
    label: 'Frontiersman brochure',
    href: '/frontiersman-voyage',
    note: 'Full voyage brochure — cultural constitution.',
  },
  {
