 ...
 * Five cruise pillars: SS Vibelandia · Journey · Jukebox · Library · Creator Studio.
 */
import {
  PLAYER_NPC_LINE,
  PLAYER_SPINE_LINE,
 ...
 * Order mirrors the cruise line: Journey → feel → read → create.
 */
export const PLAYER_PRIMARY_DOORS = [
  {
    ...
    label: 'Journey',
    href: '/journey',
    note: 'Grand narrative first — arrival loop, crests, menus of experiences, then decks and cabins.',
    cta: 'Voyage →',
    chip: 'Story',
  },
  {
...
export function renderPlayerChannelsHtml() {
  ...
  return `<h3 class="bulletin-channels-h" id="ship-channels-h">Your cruise line · four doors</h3>
