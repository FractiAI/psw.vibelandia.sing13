 ...
 * Five cruise action doors: Journey · Canvas · Jukebox · Reading Room · Creator Studio
...
export const PLAYER_PRIMARY_DOORS = [
  ...
  },
  {
    ...
    label: 'Reading Room',
    href: '/reading-room',
    note: 'Frontier club reading room — ship-blog notes and whitepapers with full abstracts when you want the map.',
    cta: 'Enter the Reading Room',
    chip: 'Read',
  },
  {
    id: 'creator',
...
export const PLAYER_MORE_DOORS = [
  {
    label: 'Demonstrations · SuperAI abilities',
    href: '/demonstrations',
    note: 'Hub for live SuperAI demos — each ability on its own dedicated door. Start here, then open Race, Chat, Overlap, or Quest.',
  },
  {
    label: 'Prime Vault Chat · Miracle 2',
    href: '/prime-vault-chat',
    note: 'Live ChatGPT-shaped Φ agent · $0 training. Walk-on with any email.',
  },
  {
    label: 'Goldilocks Quest · Next-Gen',
    href: '/goldilocks-quest',
    note: 'Under construction · five-tier climb · AI Twin · restricted Goggles. Same email seat as Let’s Chat and Lattice Chat.',
  },
  {
    label: 'Prime-Vault Race',
    href: '/prime-vault-race',
    note: 'Race scoreboard: Φ vaults vs measured ColabFold · Unmodeled Nova.',
  },
  {
  ...
  {
    label: 'Players Guide · Player 1',
    href: '/infinite-octave-players-guide',
    note: 'Infinite Octave as a playable game — primer, Gran Story, Frontiersman & Nester, daily loop.',
  },
  {
    label: 'Goldilocks Players Guide',
  ...
  {
    label: 'Infinite Octaves chart',
    href: '/octave99-chart#intake',
    note: 'Chart yourself in the grand Story. Optional depth for those who want it. Engine map Digits × 01–99.',
  },
  {
    label: 'Lattice Catalog',
    href: '/lattice#ai-catalog-layer-intro',
    note: 'Where coordination sits between agentic IDEs and ship data — woven through the doors, not bolted above them.',
  },
];

export function renderPlayerHeroCtasHtml() {
  return renderVisitGoldenPathHeroCtasHtml('ship');
}

export function renderVisitGoldenPathReceptionHtml() {
  return renderVisitGoldenPathHtml('ship', { anchorFrontDesk: '/front-desk' });
}
