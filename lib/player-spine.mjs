...
export const PLAYER_MORE_DOORS = [
  {
    label: 'Demonstrations · Prime Vault',
    href: '/demonstrations',
    note: 'Direct door: live Φ Chat + Race scoreboard on one page. No prior stop. Walk-on email for chat.',
  },
  {
    label: 'Prime Vault Chat · Miracle 2',
    href: '/demonstrations#chat',
    note: 'Live ChatGPT-shaped Φ agent on Demonstrations · $0 training. Walk-on with any email.',
  },
  {
    label: 'Goldilocks Quest · Next-Gen',
    href: '/goldilocks-quest',
    note: 'Five-tier climb · AI Twin · restricted Goggles. Same email seat as Let’s Chat and Lattice Chat.',
  },
  {
    label: 'Prime-Vault Race',
    href: '/demonstrations#race',
    note: 'Race scoreboard on Demonstrations: Φ vaults vs measured ColabFold · Unmodeled Nova.',
  },
  {
