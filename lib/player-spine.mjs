...
export const PLAYER_PRIMARY_DOORS = [
  {
    ...
    label: 'Journey',
    href: '/journey',
    note: 'Curated adventures we offer — landfalls, sails, music labs, and exhibit walks — grounded in the Official Prospectus. Not rooms. Not deck SKUs. Open the Voyage Map when you are ready to claim a cabin.',
