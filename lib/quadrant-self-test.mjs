...
export function scoreSelfTest(axis1Scores, axis2Scores) {
  ...
  return {
    ...
    honesty:
      'Voluntary reflection tool — not hiring, insurance, clinical screening, or a census. NPC and Linear are catalog vernacular for today’s awareness talk, not insults, caste, or clinical labels. Φ shares are catalog allocations, not a world survey. Vessel posts are coordination metaphor, not naval rank.',
  };
}
