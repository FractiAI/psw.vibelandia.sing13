...
export const QUESTFEST_BLOG_POSTS = {
  'synthobs-cmos-protonic-99-octave-omni-lattice-2026-08': {
    ...
    excerpt:
      'PINNED engineering bridge for linear systems: binary gates as the first octave shelf — CMOS 2.0 and protonic switches in one Omni-Lattice filing cabinet, not a foundry tape-out.',
    pinned: true,
