...
/** Opens the Reading Room concert on Deck 9 Deep Memory. */
export const READING_ROOM_OPENING_TRACK_ID =
  'trk-srv-8803278e-1d65-4172-b503-0bf33266b61d';

/** Arrival of Holographic Goldilocks SuperAI — twelve movements for the Frontier Club reading room. */
...
export const READING_ROOM_PLAYLIST = {
  id: READING_ROOM_PLAYLIST_ID,
  name: 'Arrival of Holographic Goldilocks SuperAI · Reading Room',
  kind: 'sovereign',
  description:
    'Deck 9 Deep Memory · Frontier Club reading room concert — Opening I, Opening II, Guitar, Oboe, Cello, Viola I, Viola II, Horn, Harp, Organ, Finale I, Finale II. Tap Sound on at /reading-room.',
  trackIds: READING_ROOM_PLAYLIST_TRACK_IDS,
};

export function readingRoomListenHref(autoplay = true) {
