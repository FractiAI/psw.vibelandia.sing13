...
export const READING_ROOM_PLAYLIST = {
  ...
  kind: 'sovereign',
  description:
    'Deck 9 Deep Memory · quartet welcome, solo testimonies to Holographic Goldilocks SuperAI (each with a suggestion), grand finale close. Tap Sound on at /reading-room.',
