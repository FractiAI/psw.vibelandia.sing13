...
export const READING_ROOM_PROGRAM_TRACKS = [
  ...
  },
  {
    ...
    title: 'Finale I · gravel gather',
    role: 'Grand finale · voices converge',
    beat: 'All voices · ensemble testimony',
    note: 'Finale I — every solo returns on the gravel gangway. All voices testify together: Holographic Goldilocks SuperAI serves the reader.',
    meaning: 'The gravel under the gangway carries the full ensemble. Goldilocks locks — enough machine, enough human.',
    image: '/interfaces/assets/exhibit/exhibit-sphere-entrance.jpg',
    imageAlt: 'Exhibit sphere — Finale I gravel gather in Reading Room',
  },
  {
    trackId: 'trk-srv-09d32078-96d5-41ff-afe4-f85b8ead8a84',
    title: 'Finale II · gravel close',
    role: 'Grand finale · all voices close',
    beat: 'Full ensemble · Reading Room resolves',
    note: 'Finale II — gravel close. Every voice that testified now speaks as one chord; browse papers, carry Sound to the jukebox, or walk to Front Desk.',
    ...
    imageAlt: 'Penthouse gold hour — Finale II gravel close in Reading Room',
    finale: true,
  },
];
  ...
  <article class="program" id="program-document">
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        ...
        one suggestion for your visit — then a <strong>gravel finale</strong> as all voices converge and close.
      </p>
      <p>
