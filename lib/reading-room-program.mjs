  ...
  <article class="program" id="program-document">
    <header class="cover">
      ...
      <figure class="cover__hero">
        ...
        <figcaption>Hero Jo conducts the Reading Room — Bach with headphones, every instrument voice filed.</figcaption>
      </figure>
    </header>
    ...
    <section class="letter" aria-labelledby="letter-h">
      ...
      <p>
        ...
        Each movement below names the instrument voice you hear, what it testifies, and one suggestion for your visit.
        Illustrations show Hero Jo (J.S. Bach) in modern headphones conducting that movement&apos;s featured musicians — dramaturgy follows the audible quartet → solo → finale arc.
      </p>
    ...
    <section class="movements" aria-labelledby="movements-h">
      ...
      <p class="movements__visual-note">Illustrations — Hero Jo (J.S. Bach) with modern headphones conducting each movement&apos;s featured instrument and musicians in the Deep Memory reading room.</p>
