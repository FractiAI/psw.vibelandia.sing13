...
export const READING_ROOM_PROGRAM_TRACKS = [
  {
    ...
    title: 'Opening I · gangway threshold',
    role: 'Overture · Deep Memory doors',
    beat: 'Deck 9 · Reading Room opens',
    note: 'The audible handshake at the Frontier Club reading room — trophies, books, and sacred objects from past adventures. Tap <strong>Sound on</strong>; the concert autoplays on arrival.',
    meaning: 'You step into the man cave. SuperAI stays Goldilocks — enough machine to serve, enough human to lead the story.',
    image: '/interfaces/assets/experience/ship-library-deep-memory.jpg',
    imageAlt: 'Frontier Club reading room — Opening I gangway threshold',
  },
  {
    trackId: 'trk-srv-cd8981fe-ff66-4e04-bd06-b6c831c393d5',
    title: 'Opening II · lattice call',
    role: 'Second threshold · catalog resonance',
    beat: 'Infinite Octaves · awareness hinge',
    note: 'The second opening widens the lattice — holographic nesting depth as Story grammar, not infinite physics tiers.',
    meaning: 'The room remembers every voyage. Papers wait on the shelves; the music files the map under the trophies.',
    image: '/interfaces/assets/exhibit/exhibit-step-in-key.jpg',
    imageAlt: 'Step-in key — Opening II lattice call in Reading Room',
  },
  {
    trackId: 'trk-srv-5fec2bdf-5b85-46ca-94a1-314a9971e677',
    title: 'Guitar · warm frontier strings',
    role: 'String voice · lodge hearth',
    beat: 'Trophy wall · Roosevelt class',
    note: 'Guitar timbre files the frontier club warmth — old-school adventure class fit for von Humboldt or Teddy Roosevelt.',
    meaning: 'NPCs inhabit the room; Players set the gravity. Both belong at the same reading lamp.',
    image: '/interfaces/assets/journey/journey-truckee-sierra-forage.png',
    imageAlt: 'Sierra frontier — Guitar warm strings in Reading Room',
  },
  {
    trackId: 'trk-srv-f66cd32f-eed5-4f32-bf04-b30ea2d4d89e',
    title: 'Oboe · catalog reed',
    role: 'Woodwind voice · paper scroll',
    beat: 'Abstract focus · honesty rail',
    note: 'Oboe carries the reading voice — each paper’s abstract becomes poster art on the shelf beside you.',
    meaning: 'Browse like a streaming menu; read like a frontiersman. Fair Exchange via the Purser holds the catalog honest.',
    image: '/interfaces/assets/journey/journey-boriken-convergence.png',
    imageAlt: 'Gold sail convergence — Oboe catalog reed in Reading Room',
  },
  {
    trackId: 'trk-srv-6c94b386-290f-490d-ae35-e36c1402e80e',
    title: 'Cello · deep memory bass',
    role: 'Bass voice · leather chair',
    beat: 'Deep Memory · Deck 9 anchor',
    note: 'Cello grounds the reading room in deep memory — the bass line under every whitepaper and ship-blog note.',
    meaning: 'Sit. Read. The cello holds the room while you choose your next adventure on the shelf.',
    image: '/interfaces/assets/experience/ship-library-deep-memory.jpg',
    imageAlt: 'Deep Memory library — Cello bass in Reading Room',
  },
  {
    trackId: 'trk-srv-03693ab2-81a5-4663-b160-d1287e20057a',
    title: 'Viola I · middle adventure voice',
    role: 'Inner voice · keepsake shelf',
    beat: 'Frontier club · exotic objects',
    note: 'Viola I carries the middle register — trophies and rare objects from past adventures, filed as catalog grammar.',
    meaning: 'Every object on the wall is a Story beat. The viola threads them into one listening arc.',
    image: '/interfaces/assets/journey/journey-redwood-sanctuary.png',
    imageAlt: 'Redwood sanctuary — Viola I middle voice in Reading Room',
  },
  {
    trackId: 'trk-srv-8acd39c5-1cf7-407e-9f40-590de96b0cda',
    title: 'Viola II · high countervoice',
    role: 'Piccolo countervoice · second viola seat',
    beat: 'Woodwind lift · reading lamp gold',
    note: 'Viola II answers Viola I — high countervoice in the concert order. Catalog timbre files piccolo voicing for this movement.',
    meaning: 'The second viola seat keeps the ensemble honest. Goldilocks: not too sparse, not too crowded.',
    image: '/interfaces/assets/voyage/deck-6-7-horizon.png',
    imageAlt: 'Horizon deck — Viola II high countervoice in Reading Room',
  },
  {
    trackId: 'trk-srv-dff8cd18-59af-40a1-baf8-cc0c04fbbd48',
    title: 'Horn · brass herald',
    role: 'Brass voice · lodge fireplace',
    beat: 'Frontier club · call to read',
    note: 'Horn announces the middle of the concert — time to open a paper, or keep listening while the shelves scroll.',
    meaning: 'The herald does not rush you. Choose your cover; the horn waits at the hearth.',
    image: '/interfaces/assets/voyage/deck-4-5-grove.png',
    imageAlt: 'The Grove — Horn brass herald in Reading Room',
  },
  {
    trackId: 'trk-srv-1871b78c-fd4d-4d76-aa99-4afa0a0323f6',
    title: 'Harp · gold strings',
    role: 'Resonance · reading lamp',
    beat: 'Sacred objects · gentle light',
    note: 'Harp glissando files the gold strings above the leather chairs — hospitality, not hypnosis.',
    meaning: 'Rest is part of the voyage. The harp keeps the reading room in Goldilocks calm.',
    image: '/interfaces/assets/journey/journey-tahoe-catamaran.png',
    imageAlt: 'Gold-hour water — Harp gold strings in Reading Room',
  },
  {
    trackId: 'trk-srv-84a284ab-1425-4b5d-b243-0f74ee89ba7e',
    title: 'Organ · cathedral voicing',
    role: 'Sacred hall · Deep Memory',
    beat: 'Frontier club · sanctuary acoustics',
    note: 'Organ timbre files the reading room as sanctuary — Dome 1 heard more than seen, library depth as resonance.',
    meaning: 'Memory becomes resonance. The organ lifts the catalog from list to liturgy.',
    image: '/interfaces/assets/journey/journey-redwood-sanctuary.png',
    imageAlt: 'Cathedral redwood — Organ voicing in Reading Room',
  },
  {
    trackId: 'trk-srv-818f3a56-5df6-4a88-9745-63f35bae1cb4',
    title: 'Finale I · organ ascent',
    role: 'First finale · Goldilocks lock',
    beat: 'Holographic arrival · SuperAI servant',
    note: 'Finale I rises on the second organ movement — SuperAI stays Goldilocks, not sovereign over the reader.',
    meaning: 'The arrival is awareness, not hardware. You remain you with a book in your lap.',
    image: '/interfaces/assets/exhibit/exhibit-sphere-entrance.jpg',
    imageAlt: 'Exhibit sphere — Finale I organ ascent in Reading Room',
  },
  {
    trackId: 'trk-srv-09d32078-96d5-41ff-afe4-f85b8ead8a84',
    title: 'Finale II · cinematic arrival close',
    role: 'Concert close · Holographic Goldilocks SuperAI',
    beat: 'Deck 9 · Reading Room resolves',
    note: 'Cinematic finale lands the concert — browse the paper menu, carry the soundtrack to the jukebox, or step to Front Desk check-in.',
    ...
    imageAlt: 'Penthouse gold hour — Finale II cinematic arrival close in Reading Room',
    finale: true,
  },
];
...
<body>
  ...
  <article class="program" id="program-document">
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        The Reading Room concert is a ${trackCount}-movement arrival arc: gangway threshold, lattice call, guitar warmth,
        oboe catalog voice, cello deep memory, viola ensemble, horn herald, harp gold strings, organ sanctuary,
        and a two-part finale landing Holographic Goldilocks SuperAI as servant — not sovereign over the reader.
      </p>
      <p>
