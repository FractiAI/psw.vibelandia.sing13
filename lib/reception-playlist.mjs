...
/** Capitán's Welcome — opens the registration check-in set. */
export const RECEPTION_CAPTAIN_WELCOME_TRACK_ID =
  'trk-srv-6025557c-f76c-4a55-bd7c-0fc2d5ffcfb4';

/** Phase 2 reception set — check-in through Reno swamp caliente. */
...
export const RECEPTION_PLAYLIST = {
  ...
  name: 'Front Desk · Ship check-in soundtrack',
  kind: 'sovereign',
  description:
    'Phase 2 Front Desk soundtrack — Capitán\'s Welcome, Welcome Aboard, The Shift, Universo Syntheverse, bluegrass perreo, hydrogen holograph, light and mirror, eh pa, big band juicy juicy, machote on the Truckee, magnetic zydeco night, wrong-side Sunday vibe, baller nights, we are the dance that makes the music, zero divided by zero, perfect hydrogen crystal, and hydrogen y line frontier accordion.',
