...
export const RECEPTION_PLAYLIST = {
  ...
  kind: 'sovereign',
  description:
    'Phase 2 reception soundtrack — Welcome Aboard through Universo Syntheverse, bluegrass perreo, hydrogen holograph, light and mirror, eh pa, big band juicy juicy, machote on the Truckee, magnetic zydeco night, wrong-side Sunday vibe, and baller nights.',
