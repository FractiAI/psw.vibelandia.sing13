...
export const RECEPTION_PLAYLIST = {
  ...
  kind: 'sovereign',
  description:
    'Phase 2 Front Desk soundtrack — Capitán\'s Welcome, Welcome Aboard, The Shift, Universo Syntheverse, bluegrass perreo, hydrogen holograph, light and mirror, eh pa, big band juicy juicy, machote on the Truckee, magnetic zydeco night, wrong-side Sunday vibe, baller nights, and we are the dance that makes the music.',
