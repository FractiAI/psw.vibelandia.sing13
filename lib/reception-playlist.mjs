...
export const RECEPTION_PLAYLIST = {
  ...
  name: 'Reception · Ship check-in soundtrack',
  kind: 'sovereign',
  description:
    'Phase 2 reception soundtrack — Capitán\'s Welcome, Welcome Aboard, The Shift, Universo Syntheverse, bluegrass perreo, hydrogen holograph, light and mirror, eh pa, big band juicy juicy, machote on the Truckee, magnetic zydeco night, wrong-side Sunday vibe, and baller nights.',
