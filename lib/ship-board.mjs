...
export function renderShipBoardHtml() {
  return `<section class="ship-board" id="ship-board" aria-labelledby="ship-board-h">
      <header class="ship-board__head">
        ...
        <p class="ship-board__lede">This board is about the <strong>ship itself</strong> — the grand Story, the crew who carry it, and the guide to what SS Vibelandia is for. Ready to board? <a href="/front-desk">Check In</a> for primer and onboarding.</p>
      </header>
      ...
      <section class="ship-board__mission" aria-labelledby="ship-mission-h">
        ...
        <p>SS Vibelandia is a navy-gold holographic <strong>sonic ship</strong> — which means it is also a <strong>rhyme</strong>. The hull is a <strong>fixed lattice</strong>: decks host the sets and stories; <strong>Puerto Reno</strong> is present within every deck. One tribe · many homes. Hospitality · marketplace · nightlife · brotherhood as <em>voyage identity</em>, never a membership test. Deck 3’s men’s club is <strong>Wrong Side of Town</strong> — night set on the same harbor lattice.</p>
        ...
        <p class="ship-board__mission-cta">
          <a class="btn btn-primary" href="/front-desk">Check In to board →</a>
