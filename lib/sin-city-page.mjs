/**
 * Wrong Side of Town · Deck 3 Night experience page — same ep-hero shell as Front Desk / Reading Room.
...
<head>
  ...
  <title>Wrong Side of Town · Deck 3 — Night · SS Vibelandia</title>
  <meta name="description" content="Wrong Side of Town · Deck 3 — Night. Valet Pru hosts J.S. Bach holographically with Suno AI studio musicians. Soundtrack prelude, concert program, consent-first nightlife." />
  <link rel="canonical" href="https://www.ssvibelandiaquestfest24x365.com/voyage/deck-3-night" />
  <meta property="og:title" content="Wrong Side of Town · Deck 3 — Night · SS Vibelandia" />
...
<body class="canvas-site">
  ...
  <main class="sin-city-page">
    <p class="lede">
      ...
      <strong>Wrong Side of Town</strong> is the men’s club set on Deck 3 of a holographic sonic ship — a fixed lattice rhyme where <strong>Puerto Reno</strong> is present on every deck.
    ...
    <p>
      Read the <a href="${SIN_CITY_PROGRAM_ROUTE}">Wrong Side of Town night program</a> for Valet Pru · holographic J.S. Bach · Suno AI studio dramaturgy —
    ...
    <p>Wrong Side of Town · men’s club · Bachdoor Speakeasy · Neon Velvet · Club Omnia · Red Room (consensual adults-only — you remain you).</p>
    <p>Adults-only where marked. Puerto Reno rhymes through the night — same harbor, night set. The whole tribe still belongs on this ship. Human care outranks every score.</p>
    ...
    <footer>SS Vibelandia · Wrong Side of Town · Deck 3 — Night · → ∞^∞</footer>
  </main>
