...
export const SIN_CITY_PLAYLIST = {
  ...
  kind: 'sovereign',
  description:
    'Deck 3 Night soundtrack — let\'s go holographic tonight, dos mejor q una mami, and tired eyes. Sin City originals only; Front Desk boarding set lives on pl-reception.',
