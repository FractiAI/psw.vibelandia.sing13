...
export const SIN_CITY_PLAYLIST = {
  ...
  kind: 'sovereign',
  description:
    'Deck 3 Night soundtrack — let\'s go holographic tonight, magnetic zydeco night, holographic perreo night, downtown Reno, baller nights, wrong-side Sunday gold, and we are the dance that makes the music.',
