...
/** Opens the Wrong Side of Town night set on Deck 3. */
export const SIN_CITY_OPENING_TRACK_ID =
  'trk-srv-1ff974cf-7864-4c5d-8b22-2c4aa493d340';

/** Wrong Side of Town-only tracks — not shared with Front Desk pl-reception. */
export const SIN_CITY_CLOSING_TRACK_ID =
  'trk-srv-5c34e10b-b181-47ff-b348-9afbaf06c083';

/** Deck 3 Night · Wrong Side of Town originals only. */
...
export const SIN_CITY_PLAYLIST = {
  ...
  name: 'SS Vibelandia Wrong Side of Town',
  kind: 'sovereign',
  description:
    'Deck 3 Night soundtrack — let\'s go holographic tonight, dos mejor q una mami, tired eyes, buena mota, mezcal y café, ando bellaco baby, creo q esta noche me la como 2, and fumando puro (lo fi bolero session). Wrong Side of Town originals only; Front Desk boarding set lives on pl-reception.',
