/**
 * Wrong Side of Town night program illustrations —
...
const kit = createProgramImageKit({
  ...
  heroAlt:
    'J.S. Bach with modern headphones holographically hosting Wrong Side of Town night instruments',
  defaultAlt: 'J.S. Bach conducting Wrong Side of Town night instruments',
