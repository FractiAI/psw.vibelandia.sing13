...
export const SIN_CITY_PROGRAM_TRACKS = [
  ...
  },
  {
    ...
    role: 'Finale · Neon Velvet · Club Omnia close',
    ...
    image: '/interfaces/assets/voyage/deck-3-night.png',
    imageAlt: 'Neon Velvet floor — ando bellaco baby Sin City finale',
    finale: true,
  },
];
...
<body>
  ...
  <article class="program" id="program-document">
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        The Sin City soundtrack is a ${trackCount}-track night set: holographic invitation, mami floor, tired eyes, mezcal lounge, and <em>ando bellaco baby</em> close.
