...
export const SIN_CITY_PROGRAM_TRACKS = [
  ...
  },
  {
    ...
    title: 'tired eyes',
    role: 'Finale · afterglow · last call',
    beat: 'Neon dims · you remain you',
    note: 'Late-night close on Deck 3 — rest is part of the voyage. Sin City originals only; the full boarding arc lives on the <a href="/front-desk-program">Front Desk check-in set</a>.',
    meaning: 'Human care outranks every score. Fair Exchange via the Purser closes the night. → ∞^∞',
    image: '/interfaces/assets/journey/journey-tahoe-catamaran.png',
    imageAlt: 'Gold-hour afterglow — tired eyes Sin City close',
    finale: true,
  },
];
...
<body>
  ...
  <article class="program" id="program-document">
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        The Sin City soundtrack is a tight three-track night set: holographic invitation, mami floor, tired eyes close.
