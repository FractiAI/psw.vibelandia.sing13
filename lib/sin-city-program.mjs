/**
 * Wrong Side of Town · Deck 3 Night program — dramaturgy for pl-sin-city.
...
export const SIN_CITY_PROGRAM_TRACKS = [
  {
    ...
    beat: 'Deck 3 Night opens · Wrong Side of Town invitation',
  ...
  },
  {
    ...
    note: 'Mezcal, café, and honest catalog — speakeasy close, not clinical advice. Wrong Side of Town originals only; full boarding arc on the <a href="/front-desk-program">Front Desk check-in set</a>.',
  ...
  },
  {
    ...
    note: 'Latin night pulse on the Wrong Side of Town floor — adults-only where marked, you remain you. Wrong Side of Town originals only; full boarding arc on the <a href="/front-desk-program">Front Desk check-in set</a>.',
  ...
  },
  {
    ...
    note: 'Latin night sequel on the Wrong Side of Town floor — adults-only where marked, you remain you. Wrong Side of Town originals only; full boarding arc on the <a href="/front-desk-program">Front Desk check-in set</a>.',
  ...
  },
  {
    ...
    note: 'Lo-fi bolero on the Wrong Side of Town lounge — catalog grammar only, not clinical advice. Wrong Side of Town originals only; full boarding arc on the <a href="/front-desk-program">Front Desk check-in set</a>.',
...
export function assertSinCityProgramTrackOrder() {
  ...
  if (programIds.length !== SIN_CITY_PLAYLIST_TRACK_IDS.length) {
    throw new Error(
      `Wrong Side of Town program track count (${programIds.length}) != playlist (${SIN_CITY_PLAYLIST_TRACK_IDS.length})`,
    );
  }
  for (let i = 0; i < programIds.length; i += 1) {
    if (programIds[i] !== SIN_CITY_PLAYLIST_TRACK_IDS[i]) {
      throw new Error(
        `Wrong Side of Town program track order mismatch at index ${i}: ${programIds[i]} != ${SIN_CITY_PLAYLIST_TRACK_IDS[i]}`,
      );
    }
  }
}
...
/** Full Broadway-style Wrong Side of Town program HTML (synced to interfaces/sin-city-night-program.html). */
...
<head>
  ...
  <title>Wrong Side of Town Night Program · J.S. Bach · SS Vibelandia</title>
  ...
  <meta property="og:title" content="Wrong Side of Town Night Program · J.S. Bach · SS Vibelandia" />
...
<body>
  <div class="program-toolbar no-print">
    <nav aria-label="Site">
      <a href="/voyage/deck-3-night">Wrong Side of Town · Deck 3</a>
  ...
  <article class="program" id="program-document">
    <header class="cover">
      ...
      <h1>Wrong Side of Town<br />Night Program</h1>
    ...
    <section class="letter" aria-labelledby="letter-h">
      ...
      <p>
        You are holding the program for <strong>Wrong Side of Town</strong>.
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        The Wrong Side of Town soundtrack is a ${trackCount}-track night set: holographic invitation, mami floor, tired eyes, mezcal lounge, <em>ando bellaco baby</em>, <em>creo q esta noche me la como 2</em> close, and <em>fumando puro (lo fi bolero session)</em> epilogue.
      ...
      <table class="order-table" aria-label="Wrong Side of Town night play order">
        <thead>
    ...
    <section class="music-promo no-print" aria-labelledby="music-promo-h">
      ...
      <p>See the concert program — download a PDF or open the full Wrong Side of Town playlist in the jukebox.</p>
    ...
    <footer class="program-foot">
      SS Vibelandia · Wrong Side of Town Night Program · Featuring J.S. Bach · Edition 2026-09-03<br />
      <a href="/voyage/deck-3-night">Wrong Side of Town</a> · <a href="/front-desk-program">Check-in program</a> · <a href="mailto:info@fractiai.com">info@fractiai.com</a>
    </footer>
  </article>
