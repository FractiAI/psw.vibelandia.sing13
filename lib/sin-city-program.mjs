...
export const SIN_CITY_PROGRAM_TRACKS = [
  ...
  },
  {
    ...
    role: 'Finale · Neon Velvet · call and response',
    beat: 'Club floor · two beats one groove',
    note: 'Latin night grammar on Deck 3 — consent-first, you remain you. Sin City originals only; the full boarding arc lives on the <a href="/front-desk-program">Front Desk check-in set</a>.',
    meaning: 'Hostesses and dancers carry the hospitality. Players set the gravity the floor orbits. → ∞^∞',
    image: '/interfaces/assets/voyage/deck-3-night.png',
    imageAlt: 'Neon Velvet floor — dos mejor q una mami finale',
    finale: true,
  },
];
...
<body>
  ...
  <article class="program" id="program-document">
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        The Sin City soundtrack is a tight two-track night pair: holographic invitation, then the mami floor.
