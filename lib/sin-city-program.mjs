...
<body>
  ...
  <article class="program" id="program-document">
    ...
    <section class="synopsis" aria-labelledby="synopsis-h">
      ...
      <p>
        The Sin City soundtrack is a ${trackCount}-track night set: holographic invitation, mami floor, tired eyes, mezcal lounge, <em>ando bellaco baby</em>, and <em>creo q esta noche me la como 2</em> close.
