/**
 * Guest-facing ship label — SS VIBELANDIA (not QUESTFEST).
 * Site root `/` is Omniversal Canvas (art landing); the ship board is `/questfest`.
 */
export const SITE_HOME_LABEL = 'SS VIBELANDIA';
export const SITE_HOME_HREF = '/questfest';
