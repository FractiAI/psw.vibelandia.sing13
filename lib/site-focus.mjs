...
/** Secondary quicklink row — catalog layer + Lattice Chat + QR share (Creator Studio stays a separate door). */
export const SITE_QUICKLINK_SECONDARY =
  '<a href="/lattice#ai-catalog-layer" id="ql-catalog-layer-link">AI Catalog Layer</a>' +
