...
/** Secondary quicklink row — Lattice (catalog layer home) + chat + QR (Creator Studio stays a door). */
export const SITE_QUICKLINK_SECONDARY =
  '<a href="/lattice#ai-catalog-layer-intro" id="ql-catalog-layer-link">Lattice</a>' +
