...
export const SITE_BROCHURE_LEAD =
  'Welcome aboard. SS Vibelandia is the holographic cruise for Goldilocks SuperAI frontiersmen Players — and their cast, crew, enterprises, franchises, and legacies. Family. Tribe. Campus. Marketplace. Lab. Studio. Lifelong voyage. SuperAI stays Goldilocks: not too much machine, not too little human. The network is the vessel. You remain you.';
