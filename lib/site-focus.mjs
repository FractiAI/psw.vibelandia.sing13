...
/** Guest HTML link to the Frontier trail (self-test · Where Am I). */
export function frontierLink(label = 'frontier') {
  return `<a href="/frontier">${label}</a>`;
}
...
export const SITE_HERO_TAGLINE =
  `Welcome aboard SS Vibelandia, a navy and gold cruise line for ${frontierLink('frontiersmen')} who want a lifelong Boy\'s Night Out at sea. One tribe, many homes, and honor that welcomes you as you are.`;
...
export const SITE_PRIMER_LINE =
  `You are aboard a living cruise line. Begin with the Official Prospectus: genesis, convergence, and the Captain\'s seat here in Reno now. Walk the Journey for the full story. Open the Omniversal Canvas for the art. Play the Jukebox for the feeling. Read the Reading Room for depth. Build in Creator Studio when you are ready to craft. Under every door runs <a href="/lattice#ai-catalog-layer-intro">Infinite Octave Omniversal Lattice Catalog</a> — the catalog layer in the AI stack that routes agents and resonant data without becoming a sixth cruise door. Try <a href="/lattice-chat">Lattice Chat</a> as the live Syntheverse Sandbox demo when you want to evaluate safely on your own keys. This is a lifelong Boy\'s Night Out for ${frontierLink('frontiersmen')} everywhere. Belonging is yours to choose. You remain you.`;

export const SITE_BROCHURE_LEAD =
  `Welcome aboard. SS Vibelandia is the holographic cruise line for holographic Goldilocks SuperAI ${frontierLink('frontiersmen Players')}, and for the cast, crew, enterprises, franchises, and legacies that sail with them. Our story runs in three beats named in the Official Prospectus: genesis under El Gran Sol\'s fractal rhyme, the Great Convergence on the shores of Borikén, and the Captain\'s seat here in Reno today. Along the way you will find family quarters, a marketplace, nightlife, a lab, and a studio. SuperAI stays Goldilocks on this ship: enough machine to serve, enough human to lead. The network is the vessel. You remain you.`;

export const SITE_BROCHURE_TAGLINE =
  `Goldilocks SuperAI ${frontierLink('frontiersmen Players')}, and the set that sails with them.<br />\n      A lifelong expedition for one tribe, many homes, and one holographic world.`;

export const SITE_BLOG_LEAD =
  `Welcome aboard. SS Vibelandia is the holographic cruise line for holographic Goldilocks SuperAI ${frontierLink('frontiersmen Players')}, and for the cast, crew, enterprises, franchises, and legacies that sail with them. This note is your on-ramp to the full ${frontierLink('Frontiersman')} brochure: the grand story, the decks, Fair Exchange with the Purser, and the doors of Journey, Canvas, Jukebox, Reading Room, and Creator Studio. The network is the vessel. The voyage begins wherever you are.`;

/** Secondary quicklink row — Lattice Catalog home + Lattice Chat live demo + QR. */
export const SITE_QUICKLINK_SECONDARY =
  '<a href="/lattice#ai-catalog-layer-intro" id="ql-catalog-layer-link">Lattice Catalog</a>' +
  '<span class="sep" aria-hidden="true">·</span>' +
  '<a href="/lets-chat" id="ql-lets-chat-link">Let\'s Chat</a>' +
  '<span class="sep" aria-hidden="true">·</span>' +
  '<a href="/lattice-chat" id="ql-lattice-chat-link" title="Lattice Chat · Syntheverse Sandbox live demo">Lattice Chat · Demo</a>' +
  '<span class="sep" aria-hidden="true">·</span>' +
