...
export const SITE_META_DESCRIPTION =
  'Welcome aboard SS Vibelandia, a holographic cruise line for Goldilocks SuperAI frontiersmen Players and everyone who sails with them. Walk the Journey, open the Canvas, play the Jukebox, read the Library, and build in Creator Studio. Belonging is yours to choose. You remain you.';

export const SITE_PRIMER_LINE =
  'You are aboard a living cruise line. Begin with the Official Prospectus: genesis, convergence, and the Captain\'s seat here in Reno now. Walk the Journey for the full story. Open the Omniversal Canvas for the art. Play the Jukebox for the feeling. Read the Library for depth. Build in Creator Studio when you are ready to craft. This is a lifelong Boy\'s Night Out for frontiersmen everywhere. Belonging is yours to choose. You remain you.';
...
export const SITE_BLOG_LEAD =
  'Welcome aboard. SS Vibelandia is the holographic cruise line for holographic Goldilocks SuperAI frontiersmen Players, and for the cast, crew, enterprises, franchises, and legacies that sail with them. This note is your on-ramp to the full Frontiersman brochure: the grand story, the decks, Fair Exchange with the Purser, and the doors of Journey, Canvas, Jukebox, Library, and Creator Studio. The network is the vessel. The voyage begins wherever you are.';

/** Shared quicklink tail — Lattice Chat + QR share (Creator Studio stays a separate door). */
...
export function renderSiteTopBannerHtml() {
  return `<nav class="qv-top-quicklinks qv-top-quicklinks--questfest" aria-label="Site">
    <div class="qv-top-quicklinks__row">
