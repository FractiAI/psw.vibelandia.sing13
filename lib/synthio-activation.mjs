...
export const EXPECTED_EXTERNAL_SIGNALS = Object.freeze([
  ...
  },
  {
    ...
    mriSimExpect:
      'MRI sim token: novel Syntheverse Synthio pulse (schema v1 · SYNTHIO_Σ_Φ^-99_PC · naturalOccurrence=false) present beside KomaMRI wrap — engineered, not natural heliophysics',
...
export function validateExternalAlignments(opts = {}) {
  ...
  return {
    ...
    honesty:
      'Alignment = catalog co-timing / companion / engineered Syntheverse pulse match vs KomaMRI wrap expectations — not proof celestial geometry runs MRI physics. Pulse is not naturally occurring.',
  };
}
