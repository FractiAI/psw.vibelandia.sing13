...
export function buildActivationMonitorPack(opts = {}) {
  ...
  const logEntry = {
    ...
    level: coherence.coherent ? 'ok' : 'warn',
    activationState: activation.activationState,
    ...
    honesty:
      'External signals are watch-list co-timing / companion labels — not causal confirmation of MRI physics.',
  };
  return { activation, coherence, logEntry, expectedExternalSignals: EXPECTED_EXTERNAL_SIGNALS };
}
