...
export async function buildSynthioEngineeringPack(opts = {}) {
  ...
  return {
    ...
    appsInsideMriSimulation: CLOUD_SERVICES.appsInsideMriSimulation,
    cloudDemonstration: CLOUD_SERVICES.demonstration,
    ...
    links: {
      ...
      performancePaper:
        '/interfaces/whitepaper-surface.html?id=synthio-mri-vs-legacy-perf-proxy-2026-08',
      standaloneSuite: 'https://github.com/FractiAI/synthio-mri-cloud-antenna',
      standalonePerfSuite: 'https://github.com/FractiAI/synthio-mri-vs-legacy-perf',
