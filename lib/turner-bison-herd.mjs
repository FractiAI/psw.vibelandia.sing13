/**
 * Turner Bison Herd — live ingest → EGS scale → synthesis (NSPFRNP).
 * NOAA SWPC (real), OpenWebRX 1420 MHz RF proxy (real), public registry baseline (cited).
 */
