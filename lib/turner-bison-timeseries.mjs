...
export async function runTurnerBisonTimeseries({ startDate, endDate, sampleSize = SAMPLE_HEADS } = {}) {
  ...
  return {
    ...
    honesty: {
      ...
      groundCollaboration:
        'Accuracy and usefulness improve significantly when tuned with Turner teams on the ground (boundaries, fence corrections, receiver placement, seasonal baselines).',
    },
