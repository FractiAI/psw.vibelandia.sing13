...
export async function runPassiveRadarFusion({ wirePhaseUs, iqRms, kpLive, ingestAt, spectrumChunks = null }) {
  ...
  return { geography, fence, satellite, lstPass, steelPack, magnetic, powerGrid, radar };
}
