...
export const VOYAGE_DECKS = [
  ...
  },
  {
    ...
    cabinSlugs: [],
    actions: [
      { label: 'QUESTFEST voyage', href: '/questfest' },
...
<body class="voyage-flagship">
  <article class="wrap voyage-door-page">
    ...
    <p class="lead">Every deck and cabin SKU opens its own door — full serial register, poster image, and plain speak for Players and NPCs.</p>
    <h2>Decks</h2>
    ...
    <div class="cta-row">
      ...
      <a class="btn btn-ghost" href="/questfest">QUESTFEST</a>
    </div>
    <footer>→ ∞¹³</footer>
  </article>
  <script src="/interfaces/i18n-auto.js" data-page="surface"></script>
