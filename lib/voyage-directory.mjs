...
import { VOYAGE_MAP_POSTER, voyagePosterPath } from './voyage-posters.mjs';
...
export const VOYAGE_DECKS = [
  {
    ...
    lead: 'The crown of the ship — vision, studio, library, and workshop with a 360° horizon of pride.',
    body: [
      ...
      'Homes on this band: Captain’s Grand Penthouse · El Gran Sol penthouses · Captiva Cove beachfront cabins.',
  ...
  },
  {
    ...
    body: [
      ...
      'Miss Goldilocks? We credit you. That is pride with a backbone.',
    ],
  ...
  },
  {
    ...
    lead: 'Music, play, adult social — consent first. Nightlife as voyage pride, never a gate.',
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      'Lattice Chat lives here. Bring your own key. Attach images and notes. Build with pride.',
...
export const VOYAGE_CABINS = [
  {
    ...
    lead:
      'Sovereign Summit. Strategy, hospitality, and a 270° overlook — the captain’s welcome, never a throne over people.',
    body: [
      'One grand penthouse at the crown of the ship — hospitality with a horizon.',
      'Strategy and welcome live here. Human care still outranks the Bridge.',
      'Steps away: Acoustic Studio · Holographic Lab · Deep Memory Library · Rapid Workshop.',
    ],
    serials: ['PH-001'],
    image: voyagePosterPath('ph-001'),
    imageAlt: 'Captain’s Grand Penthouse — Sovereign Summit welcome',
    actions: [
  ...
  },
  {
    ...
    deckSlug: 'deck-9-summit',
    lead: 'Lagoon walk-out, open-air living, rainfall showers — beachfront pride on the vessel.',
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      'Bring your own key. Attach charts at the composer. Build with pride.',
    ],
...
export function renderVoyageMapPreludeHtml() {
  ...
  return `<section class="voyage-map-prelude" aria-labelledby="voyage-story-h">
      ...
      <p class="voyage-map-prelude__lede">SS Vibelandia is a navy-gold holographic <strong>resort vessel</strong> — hospitality · marketplace · nightlife · brotherhood as <em>voyage identity</em>, not a membership test. One tribe · many homes · layers that stack: physical → digital → social → narrative → symbolic → cognitive → meta.</p>
      <p>Players examine. NPCs inhabit. Both belong. SuperAI stays Goldilocks — not too much machine, not too little human. Every surface answers: <em>Where am I on the ship? What can I do here? How do I stay Goldilocks?</em></p>
      <p class="voyage-map-prelude__loop">Player loop: <strong>SEE → RECOGNIZE → INTERPRET → REFLECT → ACT → SEE AGAIN</strong> — the same rhythm as coming aboard.</p>
    </section>
    <section class="voyage-map-prelude voyage-map-prelude--menu" aria-labelledby="voyage-arrival-h">
      ...
      <p class="voyage-map-prelude__hint">Five beats before you pick a cabin:</p>
    ...
    <section class="voyage-map-prelude voyage-map-prelude--menu" aria-labelledby="voyage-crests-h">
      <h2 id="voyage-crests-h">Ship crests · live the pride</h2>
      <p class="voyage-map-prelude__hint">Six promises that color every deck:</p>
    ...
    <section class="voyage-map-prelude voyage-map-prelude--menu" aria-labelledby="voyage-do-h">
      ...
      <p class="voyage-map-prelude__hint">Craft · listen · care · voyage — choose a door:</p>
...
<body class="voyage-flagship">
  <article class="wrap voyage-door-page">
    ...
    <header>
      <p class="kicker">Your cabin · ${cabin.skuDisplay} · ${deck ? deck.label : 'Voyage'}</p>
      <h1>${cabin.name}</h1>
...
<head>
  ...
  <meta property="og:description" content="Story first — Inquire · Select · Prepare · Arrive · Live the vibe — then decks, cabins, and venues." />
  <meta property="og:image" content="https://www.ssvibelandiaquestfest24x365.com${VOYAGE_MAP_POSTER}" />
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@500;600&family=Source+Sans+3:wght@400;600;700;800&display=swap" rel="stylesheet" />
  <link rel="stylesheet" href="/interfaces/brand-gold-surfaces.css" />
  <link rel="stylesheet" href="/interfaces/ship-blog.css" />
...
<body class="voyage-flagship">
  <article class="wrap voyage-door-page">
    ...
    ${renderHeroImage(VOYAGE_MAP_POSTER, 'Voyage map — SS Vibelandia deck stack, Goldilocks layer, and network landfalls')}
    <header>
      <p class="kicker">Come aboard · Frontiersman Voyage</p>
      <h1>Voyage Map</h1>
      <p class="dateline">${VOYAGE_DOOR_SPINE}</p>
    </header>
    <p class="lead">Story first. Choices next. Homes when you are ready — the map <em>is</em> the ship.</p>
    ...
    <p class="honesty"><strong>Ship promise:</strong> Decks are places to live. Cabins are homes. Φ ≈ 1.618 is our design language — pride with honesty.</p>
    <div class="cta-row">
