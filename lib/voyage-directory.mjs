...
const EVENING_CRUISE = '/interfaces/assets/ss-vibelandia-cruise-evening.png';
...
const FRONTIER_GUIDE = '/interfaces/assets/questfest-2026-frontier-guide-cover.png';
const CAPITAN_WELCOME = '/interfaces/assets/questfest-2026-capitan-welcome.png';
const BEACH = '/interfaces/assets/fractiai-cofounders-pru-daniel-beach.png';
const VICTORY_STORY = '/interfaces/assets/questfest-2026-player1-victory-story.png';
const NEST_PUERTO_RENO = '/interfaces/assets/nesting/nest-questfest-puerto-reno.png';
const MAN_CAVE = '/interfaces/assets/nesting/nest-man-cave-restroom.png';
const HOLOGRAPHIC_OS = '/interfaces/assets/holographic-ai-os-newscast-frame.png';

/** Poster paths for deck/cabin pages — used by tests and sync. */
export const VOYAGE_DIRECTORY_IMAGES = [
  HERO_SHIP,
  EVENING_CRUISE,
  PUERTO_RENO,
  JUKEBOX,
