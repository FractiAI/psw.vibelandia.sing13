...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
  <title>Voyage Map · Holographic Decks &amp; Cabins · SS Vibelandia</title>
  <meta name="description" content="Voyage map — decks, landfalls, and cabin homes on the SS Vibelandia holographic cruise." />
  <link rel="canonical" href="${canonical}" />
  <meta property="og:title" content="Voyage Map · SS Vibelandia" />
  <meta property="og:description" content="Deck stack, landfalls, and cabin directory — Inquire · Select · Prepare · Arrive · Live the vibe." />
...
<body class="voyage-flagship">
  <article class="wrap voyage-door-page">
    ...
    <p class="lead">The map <em>is</em> the ship — decks from Core to Summit, landfalls across the network, and every cabin door ready for you.</p>
