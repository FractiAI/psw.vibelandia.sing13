...
export const VOYAGE_DECKS = [
  {
    ...
    body: [
      ...
      'Puerto Reno rhymes here too: the harbor is present on every deck of this fixed lattice — Summit just hosts the vision set.',
  ...
  },
  {
    ...
    body: [
      ...
      'Puerto Reno is still underfoot — Veranda hosts the private-life set of the same holographic harbor.',
  ...
  },
  {
    ...
    body: [
      ...
      'Puerto Reno lives in this band as balcony light — same fixed lattice, social set.',
  ...
  },
  {
    ...
    body: [
      ...
      'Puerto Reno’s marketplace rhyme sits here — Fair Exchange at the Purser’s Desk on the same harbor lattice.',
  ...
  },
  {
    ...
    shortLabel: '3 Night',
    tags:
      'Wrong Side of Town (men’s club) · Bachdoor Speakeasy · Neon Velvet · Club Omnia · Red Room (consensual adults-only — you remain you)',
    lead: 'Music, play, adult social — consent first. Nightlife as voyage honor, never a gate. Wrong Side of Town is the men’s club set on Deck 3.',
    body: [
      'Wrong Side of Town · men’s club · Bachdoor Speakeasy · Neon Velvet · Club Omnia · Red Room — the night stack.',
      'Puerto Reno rhymes through the night: same holographic harbor, night set — not a separate shore.',
  ...
  },
  {
    ...
    body: [
      ...
      'Puerto Reno is present here as craft: Lattice Chat sits on the same fixed lattice as the harbor boards.',
...
export function renderVoyageMapPreludeHtml() {
  ...
  return `<section class="voyage-map-prelude" aria-labelledby="voyage-story-h">
      ...
      <p class="voyage-map-prelude__lede">SS Vibelandia is a navy-gold holographic <strong>sonic ship</strong> — which means it is also a <strong>rhyme</strong>. The hull is a <strong>fixed lattice</strong>: decks host the sets and stories; the harbor does not move. <strong>Puerto Reno</strong> is present within <em>every</em> deck — same port, recursive layers — not a single shore leave you leave behind. Flagship of the Golden Bachdoor Hit Factory and a full cruise line of the Intelligence Age. Hospitality · marketplace · nightlife · brotherhood as <em>voyage identity</em>, never a membership test. This is a lifelong Boy’s Night Out for frontiersmen everywhere: one tribe · many homes · layers that stack without canceling each other — physical → digital → social → narrative → symbolic → cognitive → meta.</p>
