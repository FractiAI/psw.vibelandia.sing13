...
export function renderVoyageMapPreludeHtml() {
  ...
  return `<section class="voyage-map-prelude" aria-labelledby="voyage-story-h">
      ...
      <p class="voyage-map-prelude__lede">SS Vibelandia is a navy-gold holographic <strong>resort vessel</strong> — a full cruise line of the Intelligence Age. Hospitality · marketplace · nightlife · brotherhood as <em>voyage identity</em>, never a membership test. This is a lifelong Boy’s Night Out for frontiersmen everywhere: one tribe · many homes · layers that stack without canceling each other — physical → digital → social → narrative → symbolic → cognitive → meta.</p>
      <p>You are not boarding a feature list. You are stepping into a <strong>grand Story</strong> — the kind where a man notices the chaos around him, takes voluntary responsibility for a corner of it, and finds meaning by walking the deck with brotherhood and craft instead of doomscrolling alone. The ship gives you a map. You still choose the next honest step.</p>
      <p>Players examine the pattern. NPCs inhabit the world. Both belong. SuperAI stays Goldilocks — not too much machine, not too little human. Every surface answers three questions: <em>Where am I on the ship? What can I do here? How do I stay Goldilocks?</em></p>
      ...
      <p><strong>Five doors of the cruise line:</strong> <a href="/">SS Vibelandia</a> (today’s board) · <a href="/journey">Journey</a> (this map) · <a href="/jukebox">Jukebox</a> · <a href="/library">Library</a> · <a href="/creator-studio">Creator Studio</a>. Read the story and choose experiences <em>before</em> you pick decks, cabins, and penthouses below.</p>
    </section>
