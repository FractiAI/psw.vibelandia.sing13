...
export const VOYAGE_DOORS = [
  ...
  },
  {
    ...
    body: [
      ...
      'Housing Models A / B / C live under this language — network vessel, not one harbor. Regional nodes (Cartagena, Sierra, Tahoe, Downtown Reno) are landfalls, not ads.',
    ...
    actions: [
      { label: 'Deck & cabin directory', href: '/voyage/decks' },
  ...
  },
  {
    ...
    body: [
      ...
      `Welcome channel: Frontiersman Voyage brochure + Valet Pru bulletin on ${SITE_HOME_LABEL}. The voyage begins wherever you are.`,
    ],
    actions: [
      { label: `${SITE_HOME_LABEL} · today's board`, href: '/questfest#bulletin' },
  ...
  },
  {
    ...
    body: [
      ...
      'Excursions are real nodes — Truckee bikes, High Sierra forage, Tahoe catamaran, Downtown Reno heli — landfalls on the network vessel.',
  ...
  },
  {
    ...
    body: [
      ...
      'Collaborate keeps seats in the same room. SS Vibelandia is the atrium board. Ship-blog is Deep Memory in plain speak.',
