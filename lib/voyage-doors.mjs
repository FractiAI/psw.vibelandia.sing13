...
export const VOYAGE_DOORS = [
  {
    ...
    body: [
      ...
      'Reach the Purser at Deck 4 Grove — +1 (702) 900-SSVIBE or info@fractiai.com. Valet Pru answers from Downtown Reno when you need a human hand on the ground.',
...
<body class="voyage-flagship">
  <article class="wrap voyage-door-page">
    ...
    <div class="voyage-purser">
      ...
      <p>Deck 4 · The Grove · +1 (702) 900-SSVIBE · <a href="mailto:info@fractiai.com?subject=Purser%20Fair%20Exchange">info@fractiai.com</a></p>
    </div>
    <footer>
