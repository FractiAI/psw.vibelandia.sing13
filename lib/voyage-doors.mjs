 ...
 * Arrival loop + six crests — guest marketing pride (not developer notes).
 */
...
export const VOYAGE_DOORS = [
  {
    ...
    label: 'Inquire',
    title: 'Inquire',
    lead: 'Every great voyage begins with one honest question. Knock. The ship answers.',
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      'Hospitality language for a living world — pride in the pattern, care in the details.',
    ],
    actions: [
      { label: 'The Big Picture', href: '/ship-blog/everything-is-connected' },
  ...
  },
  {
    ...
    body: [
      'Frontiersman is navy-gold pride: hospitality, marketplace, nightlife, and brotherhood as voyage identity — never a membership test.',
      ...
      'The full constitution lives in the Official Frontiersman Voyage Brochure & Compendium.',
    ],
    actions: [
      { label: 'Full brochure', href: '/frontiersman-voyage' },
      { label: 'Ship-blog on-ramp', href: '/ship-blog/frontiersman-voyage' },
      { label: 'Coexist with AI', href: '/ship-blog/coexist-with-ai' },
    ],
  },
  {
    id: 'luxury-redefined',
  ...
  },
  {
    ...
    body: [
      ...
      'Pride in the pattern. Evidence still matters. Φ is our catalog key, not a substitute for truth.',
    ],
    actions: [
...
<body class="voyage-flagship">
  <article class="wrap voyage-door-page">
    ...
    ${bodyHtml}
    <p class="honesty"><strong>Ship promise:</strong> Human care first. Belonging is voluntary. Fair Exchange via the Purser. Φ ≈ 1.618 is our design language — pride in the pattern, honesty in the claims.</p>
    <div class="cta-row">
      ${actionsHtml}
