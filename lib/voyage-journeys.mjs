...
export const VOYAGE_JOURNEYS = [
  ...
  },
  {
    ...
    subtitle: 'Three tiers. Live Φ vaults vs measured ColabFold. Guest email seat.',
    ...
    lede: 'Step into the race door on Deck 2 Core: Infinite Octave prime vaults against the measured ColabFold receipt on ubiquitin, IL-2 complex, and orphan synthetic.',
    body: [
      ...
      'Prime vaults run live closed-form under Φ ≈ 1.618. ColabFold wall times and pLDDT come from the measured host receipt. Honesty rail: latency race ≠ GDT-TS or CASP medals. Fair Exchange via the Purser if hospitality misses.',
    ],
    includes: ['Guest email seat · Lattice / Let’s Chat', 'Three FastA tiers', 'Measured ColabFold receipt + live vault'],
