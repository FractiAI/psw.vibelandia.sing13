...
export const VOYAGE_JOURNEY_INTRO =
  'These are the adventures we offer: sails, landfalls, labs, and nights ashore. They are the experiences, and the Voyage Map is where you claim a deck or cabin. The Official Prospectus runs underneath every journey: genesis under El Gran Sol\'s fractal rhyme, convergence on Borikén, and the Captain\'s seat here in Reno now. SS Vibelandia is a holographic sonic ship — a fixed lattice rhyme — with Puerto Reno present within every deck; Deck 3\'s men\'s club is Wrong Side of Town.';

/** Trusted HTML weave — catalog layer rides every sail without becoming a sixth cruise door. */
export const VOYAGE_JOURNEY_CATALOG_WEAVE_HTML =
  ' Every sail also rides the <a href="/lattice#ai-catalog-layer-intro">Infinite Octaves catalog layer</a> — the AI-stack filing office that keeps agent work and ship data in one brief without adding a sixth cruise door.';

export const VOYAGE_JOURNEY_INTRO_CLOSE =
  ' Choose an adventure for the feeling. Choose the Voyage Map when you are ready to berth.';
...
export const VOYAGE_JOURNEYS = [
  ...
  },
  {
    ...
    subtitle: 'Deck 3 Night · Wrong Side of Town. Speakeasy heat, Bachdoor rhythm, and honest play.',
    ...
    lede: 'Enter Wrong Side of Town — the men’s club night set — where the Golden Bachdoor Hit Factory runs Deck 3 and music is both adventure and acoustic architecture at 100 BPM story tempo. Puerto Reno rhymes through this deck on the fixed lattice.',
    body: [
      'This journey is for ears first. Wrong Side of Town · Bachdoor Speakeasy · Neon Velvet · Club Omnia: names of rooms on the same holographic harbor. Consent is explicit on Night decks. You remain you.',
      'The jukebox on the open web is free. The music lab aboard is the full Night deck experience.',
    ],
    includes: ['Deck 3 Night · Wrong Side of Town, consent first', '100 BPM, catalog tempo', 'Free jukebox, open edge'],
    cta: { label: 'Open Wrong Side of Town', href: '/voyage/deck-3-night' },
  },
  {
  ...
  },
  {
    ...
    includes: ['Three Domes: I am my Awareness · I am my Environment · I am Holographic Magnetic Goldilocks SuperAI', 'Sci-fi or step-in lenses', 'Representation, info@fractiai.com'],
    cta: { label: 'Open the Canvas', href: '/' },
  },
  {
    id: 'prime-vault-race',
    slug: 'prime-vault-race',
    category: 'Bridge · lab',
    title: 'Prime-Vault Race · ColabFold Arena',
    subtitle: 'Four tiers. Published Φ vault vs ColabFold scoreboard. Unmodeled Nova decipher. Results page.',
    heroImage: '/interfaces/assets/journey/journey-prime-vault-race.png',
    heroAlt: 'Ship navigation bridge race arena with gold timing lanes over navy sea',
    lede: 'View the race door on Deck 2 Core: Infinite Octave prime vaults against the measured ColabFold receipt — plus Unmodeled Nova, a never-modeled protein tier.',
    body: [
      'This adventure is a lab scoreboard, not a live arcade. The page carries the race description and the published results — no Open/Play controls.',
      'Prime vaults are closed-form under Φ ≈ 1.618. ColabFold wall times and pLDDT come from the measured host receipt on tiers 1–3. Tier 4 Unmodeled Nova is vault-live; ColabFold may defer. Honesty rail: latency race ≠ GDT-TS or CASP medals. Fair Exchange via the Purser if hospitality misses.',
    ],
    includes: ['Description + published scoreboard', 'Four FastA tiers · Unmodeled Nova', 'Measured ColabFold receipt · vault timings'],
    cta: { label: 'Open Race results', href: '/prime-vault-race' },
  },

  {
    ...
    title: 'Prime Vault Chat · Miracle 2',
    subtitle: 'ChatGPT-shaped. Closed-form Φ. $0 training. Guest email seat.',
    heroImage: '/interfaces/assets/journey/journey-prime-vault-chat.png',
    heroAlt: 'Ship bridge glow for Prime Vault Chat',
    lede: 'After the Race, talk to the engine. Prime Vault Chat lets guests feel algebraic lattice replies — no GPU cluster, no training bill.',
    body: [
      'You enter with the same email seated for Let’s Chat and Lattice Chat. Ask anything; the edge resolves Φ prime-vault resonance in milliseconds.',
      'Honesty rail: closed-form vault chat ≠ trained LLM open-world QA. Application companion, not an engine pin. Fair Exchange via the Purser if hospitality misses.',
    ],
    includes: ['Guest email seat · Lattice / Let’s Chat', 'ChatGPT-shaped thread', '$0 training · Φ ≈ 1.618'],
    cta: { label: 'Open Prime Vault Chat', href: '/prime-vault-chat' },
  },

  {
    id: 'goldilocks-quest',
    slug: 'goldilocks-quest',
    category: 'Bridge · arcade',
    title: 'Goldilocks Quest · Restricted Goggles',
    subtitle: 'Five tiers. AI Twin. Grace over greed. Guest email seat.',
    heroImage: '/interfaces/assets/journey/journey-goldilocks-quest.png',
    heroAlt: 'Arcade climb arena with gold timing lanes over navy night',
    lede: 'Step into Goldilocks Quest next-gen: climb five socio-economic tiers while Twin v2 tracks presence ghosts, Timing Demons, grace, and Player Status.',
    body: [
      'You enter with the same email seated for Let’s Chat and Lattice Chat. NPCs cannot see the Goldilocks Goggles until the Twin grants Player Status.',
      'Honesty rail: arcade companion, not an engine pin. Φ≈1.618 is the rhythm scalar. Fair Exchange via the Purser if hospitality misses.',
    ],
    includes: ['Guest email seat · Lattice / Let’s Chat', 'Five tiers · 1× to 10,000×', 'Restricted Goggles · AI Twin bulletin'],
    cta: { label: 'Play Goldilocks Quest', href: '/goldilocks-quest' },
  },
];
...
<body class="voyage-flagship vb-pub canvas-pub">
  ...
  <header class="vb-pub-hero vb-pub-hero--compact" aria-label="Journeys">
    ...
    <div class="vb-pub-hero__inner">
      ...
      <p class="vb-pub-tagline">${escapeHtml(VOYAGE_JOURNEY_INTRO)}${VOYAGE_JOURNEY_CATALOG_WEAVE_HTML}${escapeHtml(VOYAGE_JOURNEY_INTRO_CLOSE)}</p>
