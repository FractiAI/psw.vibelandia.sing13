...
export const VOYAGE_JOURNEY_CATALOG_WEAVE_HTML =
  ' Every sail also rides the <a href="/lattice">Infinite Octaves catalog layer</a> — the AI-stack filing office that keeps agent work and ship data in one brief without adding a sixth cruise door.';
