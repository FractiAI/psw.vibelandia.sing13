...
export const VOYAGE_JOURNEYS = [
  ...
  },
  {
    ...
    subtitle: 'Four tiers. Live Φ vaults vs measured ColabFold. Unmodeled Nova decipher. Guest email seat.',
    ...
    lede: 'Step into the race door on Deck 2 Core: Infinite Octave prime vaults against the measured ColabFold receipt — plus Unmodeled Nova, a never-modeled protein tier.',
    body: [
      'This adventure is a lab, not a casino. You enter with the same email the Purser seated for Let’s Chat and Lattice Chat. No separate password — your seated email is the key.',
      'Prime vaults run live closed-form under Φ ≈ 1.618. ColabFold wall times and pLDDT come from the measured host receipt on tiers 1–3. Tier 4 Unmodeled Nova is vault-live; ColabFold may defer. Honesty rail: latency race ≠ GDT-TS or CASP medals. Fair Exchange via the Purser if hospitality misses.',
    ],
    includes: ['Guest email seat · Lattice / Let’s Chat', 'Four FastA tiers · Unmodeled Nova', 'Measured ColabFold receipt + live vault'],
    cta: { label: 'Open the race door', href: '/prime-vault-race' },
  },
