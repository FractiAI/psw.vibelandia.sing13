...
/** First-person bow still. Places the reader aboard before the schematic chart. */
export const VOYAGE_MAP_STORY_HERO = '/interfaces/assets/voyage/voyage-map-aboard-hero.png';

/** First-person lobby threshold. Arrival beat of the Voyage Map. */
export const VOYAGE_MAP_COME_ABOARD = '/interfaces/assets/voyage/voyage-map-come-aboard.png';
