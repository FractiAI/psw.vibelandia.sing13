...
export const CATALOG_SURFACES = [
  ...
  },
  {
    ...
    href: '/special-projects/ip-infringement-draft',
    category: 'special-projects',
    docId: 'IP-INFRINGE-2026-07',
    published: '2026-07-10',
    tags: ['IP', 'Code-Print', 'Neuronpedia', 'Sequoia', 'Altimeter'],
    type: 'surface',
  ...
  },
  {
    ...
    href: '/special-projects/j-lens-live',
    category: 'special-projects',
    docId: 'IP-INFRINGE-2026-07',
    published: '2026-07-10',
    tags: ['J-Lens', 'SynthOBS', 'King Bee', '1.618', 'open-weights'],
    type: 'surface',
    whitepaperId: 'ip-infringement-draft-2026-07',
    featured: true,
  },
