...
export const WHITEPAPER_REGISTRY = {
  ...
  'egs-trans-jspace-convergence-2026-07': {
    file: 'docs/EGS_TRANS_SILICON_BIOLOGICAL_CONVERGENCE_JSPACE_2026-07-10.md',
    title:
      'The Silicon-Biological Convergence: King Bee Directive & Anthropic J-Space Structural Validation',
  ...
  'ip-infringement-draft-2026-07': {
    file: 'docs/IP_INFRINGEMENT_DRAFT_2026-07.md',
    title: 'IP Infringement Draft · Immediate Audit Recommendations',
    docId: 'IP-INFRINGE-2026-07',
    category: 'reproducible-research',
    published: '2026-07-10',
    tags: ['IP', 'infringement', 'Code-Print', 'J-Lens', 'SynthOBS', 'King Bee', 'Neuronpedia'],
    featured: true,
  },
  'ip-assertion-notice-draft-2026-07': {
    file: 'docs/IP_ASSERTION_NOTICE_DRAFT_2026-07.md',
    title: 'IP Assertion Notice · Draft (Not Sent)',
    docId: 'IP-ASSERT-ANTHROPIC-IPO-2026-07-DRAFT',
    category: 'protocols',
    published: '2026-07-10',
    tags: ['IP', 'legal-draft', 'Sequoia', 'Altimeter', 'Anthropic'],
    featured: false,
  },
  'open-source-compliance-notice-draft-2026-07': {
    file: 'docs/OPEN_SOURCE_COMPLIANCE_NOTICE_DRAFT_2026-07.md',
    title: 'Open Source Compliance Notice · Draft (Not Sent)',
    docId: 'OSCN-FRACTIAI-ROOT-AUTHORITY-2026-07-DRAFT',
    category: 'protocols',
    published: '2026-07-10',
    tags: ['IP', 'open-source', 'RIX', 'Jacobsen', 'compliance-draft'],
    featured: false,
  },
};
...
export const WHITEPAPER_PUBLIC_SLUGS = {
  ...
  'egs-trans-jspace-convergence-2026-07': 'egs-trans-jspace-convergence',
  'ip-infringement-draft-2026-07': 'ip-infringement-draft',
  'ip-assertion-notice-draft-2026-07': 'ip-assertion-notice-draft',
  'open-source-compliance-notice-draft-2026-07': 'open-source-compliance-notice-draft',
};
