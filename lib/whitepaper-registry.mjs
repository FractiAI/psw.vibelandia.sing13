...
export const WHITEPAPER_REGISTRY = {
  ...
  'synthobs-prime-vault-alphafold-race-2026-09': {
    ...
    title:
      'Race Report: Infinite Octave Prime-Vault vs ColabFold (AlphaFold-class) — Measured Three-Tier Latency · pLDDT',
  ...
  'synthobs-goldilocks-quest-door-2026-09': {
    ...
    title: 'Goldilocks Quest Door · Guest Rollout Announcement',
    docId: 'WP-SYNTHOBS-GOLDILOCKS-QUEST-DOOR-2026-09-06',
    category: 'hhf',
    published: '2026-09-06T23:30:00Z',
    tags: [
      'SynthOBS',
      'Goldilocks Quest',
      'guest door',
    ...
    newsLead: true,
    catalogPriority: 9,
    pinLabel: 'Goldilocks Quest · guest door announcement',
    auditStatus: 'pass',
  },
