...
export const WHITEPAPER_REGISTRY = {
  ...
  'synthobs-tbme-spherical-solar-focus-2026-08': {
    ...
    title:
      'Solar-Focus Dynamics of Spherical Mirror Lattices & Somatic Matter Rendering — Reno Quartet #4',
  ...
  'synthobs-tbme-recursive-field-drag-2026-08': {
    ...
    title:
      'The Recursive Field-Drag Theorem — Field Self-Interference & Temporal Deceleration (Omni-Lattice Core Part V)',
