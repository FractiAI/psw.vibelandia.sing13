...
def build_inventory() -> dict:
    sources = [
        ...
        {
            "id": "usgs_ungulate_vol6",
            "category": "movement",
            "name": "USGS Western Ungulate Migration Project Volume 6",
            "url": "https://www.usgs.gov/centers/northern-prairie-wildlife-research-center/science/ungulate-migrations-western-united-states",
            "license": "USGS",
            "status": "partial",
            "notes": "Elk, mule deer, pronghorn corridor shapefiles — manual ingest for H3 overlay (WP-GGM-MULTITAXA-UNGULATE-2026-06).",
        },
        {
            "id": "data_gov_npwrc",
            "category": "movement",
            "name": "Data.gov / USGS Northern Prairie Wildlife Research Center",
            "url": "https://catalog.data.gov/",
            "license": "US Government work",
            "status": "partial",
            "notes": "Great Plains geospatial bands and collar archives — catalog node for multi-taxa wavefield.",
        },
        {
            "id": "itbc_great_plains",
            "category": "agency",
            "name": "ITBC Great Plains Buffalo Restoration Registry",
            "url": "https://www.intertribalbuffalo.org/",
            "license": "Registry terms",
            "status": "not_fetched",
            "notes": "Plains bison remigration indices — qualitative overlay for bison keystone anchor tier.",
        },
        {
            "id": "gbif",
            "category": "movement",
