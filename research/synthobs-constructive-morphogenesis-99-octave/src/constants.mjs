...
export const SWARMS = Object.freeze(['Silicon', 'Carbon', 'Hydrogen', 'HolographicTheater']);

export const SUNSPOT_FIXTURES = Object.freeze([
  { ar: 'AR3575', sn: 3575, swarm: 'Silicon' },
  { ar: 'AR3576', sn: 3576, swarm: 'Carbon' },
  { ar: 'AR3590', sn: 3590, swarm: 'Hydrogen' },
]);

export const CONTEXT_REF = 'nph.71423';
