#!/usr/bin/env node
/**
 * Empirical pipeline — Infinite Octave Prime-Parity Framework
 * Doc: WP-SYNTHOBS-INFINITE-OCTAVE-PRIME-PARITY-2026-09-04
 */
import fs from 'node:fs/promises';
import path from 'node:path';
import { fileURLToPath } from 'node:url';
import { DOC_ID, REGISTRY_ID, STUDY_TITLE, PHI_EGS, HONESTY } from '../src/constants.mjs';
...
async function main() {
  ...
  console.log(
    JSON.stringify(
      {
        ok: results.all_pass,
        repo: 'https://github.com/FractiAI/synthobs-infinite-octave-prime-parity',
