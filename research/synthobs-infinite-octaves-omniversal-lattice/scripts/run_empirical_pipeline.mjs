...
async function main() {
  ...
  const report = {
    ...
    honestyBoundary:
      'Infinite Octaves names recursive nesting; engine pin stays 99 Octave Omni-Lattice.',
    results,
  };
  ...
  console.log(
    JSON.stringify(
      {
        ok: results.all_pass,
        repo: 'https://github.com/FractiAI/synthobs-infinite-octaves-omniversal-lattice',
