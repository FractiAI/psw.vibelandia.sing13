...
async function main() {
  ...
  const report = {
    ...
    honestyBoundary:
      'Architectural narrative map. Not prophecy or clinical claims. EX-LOC figures are design targets. k=0 is a registry locus, not a proven physics singularity.',
    results,
  };
