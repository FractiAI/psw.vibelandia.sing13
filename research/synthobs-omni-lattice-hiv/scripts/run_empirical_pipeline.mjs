#!/usr/bin/env node
/**
 * Empirical pipeline — Omni-Lattice HIV adversarial operator
 * Doc: WP-SYNTHOBS-OMNI-LATTICE-HIV-2026-07
 */
...
async function main() {
  ...
  const report = {
    ...
    honestyBoundary:
      'HIV Omni-Lattice III simulation. Not clinical. Draft EX figures are design targets. Does not romanticize disease.',
    results,
  };
