...
```json
{
  ...
  "standard_C": 81.81818181818181,
  "omni_C": 94.11764705882352,
  "published": {
    "standard": 82,
    "omni": 94
  },
...
```json
{
  ...
  "I_standard": 0.42857142857142855,
  "I_omni": 12,
  "ratio": 28,
  "interpretation": "Fewer free/unobserved inputs raise Occam-style irreducibility for Omni-Lattice map.",
  "honesty": "Derived-phenomena counts are rubric-authored; not a claim DM/DE are nonexistent.",
...
### E4_dark_sector_bookkeeping — Dark sector fractions — 27% + 68% ≈ 95%
...
```json
{
  ...
  "dark_matter": 0.27,
  "dark_energy": 0.68,
  "sum": 0.9500000000000001,
  "published_fraction": 0.95,
...
- **Pass:** `true`
- **Interpretation:** Report card covers mass deficit, acceleration, unification, empirical history, portability.
...
### E6_ef_identity — E_F contrast invariant + λ_EGS identity
