...
This repository is **standalone**. It is **not** wired into the Lattice Chat Agent product engine.
...
Architectural / in-silico observation metrics and authored fixtures. Not microscopy hardware, not physics derivation, not live vendor invoices, not Lattice Chat Agent engine code.
