...
**Honesty:** Architectural + simulation validation. Draft abstract figures (41.8%, $\sigma^2=0.0002$, \$/task table) are **design targets** unless the receipt matches. Not chemistry derivation or Cursor invoices.

Paper: catalog `docs/SYNTHOBS_PHASE_LOCKED_CHEMICAL_BOND_METAPHORS_2026-07.md`
