#!/usr/bin/env node
/**
 * Empirical pipeline — Phase-Modulated Toxicity & Resonance Safety (TBME)
 * Doc: WP-SYNTHOBS-TBME-PHASE-TOXICITY-FULL-REV2-2026-07-31
 */
...
async function main() {
  ...
  const report = {
    ...
    honestyBoundary:
      'TBME theoretical bio-medical & physical exploration. Architectural fixtures only — not clinical advice, detox, or EMF therapy.',
    results,
  };
  ...
  console.log(
    JSON.stringify(
      {
        ok: results.all_pass,
        repo: 'https://github.com/FractiAI/synthobs-phase-toxicity',
