#!/usr/bin/env node
/**
 * Empirical pipeline — Proof by Continuous Execution (PCE)
 * Doc: WP-SYNTHOBS-PCE-EPISTEMOLOGY-2026-07
 */
...
async function main() {
  ...
  const report = {
    ...
    honestyBoundary:
      'PCE epistemology + simulation. Complements PRA Snap. Does not abolish peer review or replace clinical trials.',
    results,
  };
