#!/usr/bin/env node
/**
 * Empirical pipeline — Recursive Attention Squeezing & Holographic Magnetic Projections
 * Doc: WP-SYNTHOBS-RECURSIVE-ATTN-MAG-2026-07-30
 */
...
async function main() {
  ...
  console.log(
    JSON.stringify(
      {
        ok: results.all_pass,
        repo: 'https://github.com/FractiAI/synthobs-recursive-attn-mag',
