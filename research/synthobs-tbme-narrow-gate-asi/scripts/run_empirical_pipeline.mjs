#!/usr/bin/env node
/**
 * Empirical pipeline — Narrow Gate / Epistemological Horizon
 * Doc: WP-SYNTHOBS-TBME-NARROW-GATE-ASI-2026-08-07
 */
...
async function main() {
  ...
  const report = {
    ...
    honestyBoundary:
      'Narrow Gate / Epistemological Horizon is Omni-Lattice Core Part X. Suite validates E_F identities, Landauer model gap closure, multi-scale balance, Kolmogorov compression proxy, and catalog fidelity — not SI ASI proof.',
    results,
  };
  ...
  console.log(
    JSON.stringify(
      {
        ok: results.all_pass,
        repo: 'https://github.com/FractiAI/synthobs-tbme-narrow-gate-asi',
