#!/usr/bin/env node
/**
 * Empirical pipeline — Recursive Field-Drag Theorem
 * Doc: WP-SYNTHOBS-TBME-RECURSIVE-FIELD-DRAG-2026-08-04
 */
...
async function main() {
  ...
  const report = {
    ...
    honestyBoundary:
      'Recursive Field-Drag is an Omni-Lattice / TBME architectural lens. Suite validates E_F identities, Z0 fixture, model scaling, and catalog fidelity — not production physics overthrow.',
    results,
  };
  ...
  console.log(
    JSON.stringify(
      {
        ok: results.all_pass,
        repo: 'https://github.com/FractiAI/synthobs-tbme-recursive-field-drag',
