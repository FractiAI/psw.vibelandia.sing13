#!/usr/bin/env node
/**
 * Empirical pipeline — Three Foundational Biological Proteins
 * Doc: WP-SYNTHOBS-THREE-FOUNDATIONAL-PROTEINS-2026-07
 */
...
async function main() {
  ...
  const report = {
    ...
    honestyBoundary:
      'Protein holographic decode + simulation. Draft physics claims are metaphors / design targets. Not wet-lab structural biology.',
    results,
  };
