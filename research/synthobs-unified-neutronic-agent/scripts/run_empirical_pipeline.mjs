#!/usr/bin/env node
/**
 * Empirical pipeline — Unified Neutronic Agent / ILAM
 * Doc: WP-SYNTHOBS-UNIFIED-NEUTRONIC-AGENT-2026-07
 */
...
async function main() {
  ...
  const report = {
    ...
    honestyBoundary:
      'Architectural ILAM + simulation. Draft abstract figures are design targets unless receipt-matched. Not nuclear evaluation or invoice claims.',
    results,
  };
