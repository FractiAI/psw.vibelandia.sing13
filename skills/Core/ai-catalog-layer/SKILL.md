...
# When to use
Asks about the AI stack catalog layer, GPU cool / token mitigation framing, or resonant data management.

# Pointers (local)
- `docs/SYNTHOBS_INFINITE_OCTAVE_AI_CATALOG_LAYER_2026-09.md`
- `/ship-blog/infinite-octave-ai-catalog-layer`
- `lib/lattice-catalog-layer.mjs` — content constants for ship weave

# Honesty
Catalog architecture for agentic coordination — not a promise that GPUs disappear.
