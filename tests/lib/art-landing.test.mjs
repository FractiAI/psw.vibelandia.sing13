...
describe('Art landing · Omniversal Canvas is site root', () => {
  ...
  it('landing autoplays The Shift, Goldilocks Parabola, Return 05 Suite, Movement X with the da Vinci loop', () => {
    ...
    expect(html).toContain('prelude-session');
    ...
    expect(js).toContain('schedulePlayRetries');
    expect(read('interfaces/canvas-prelude-session.js')).toContain('/api/catalog-plays');
