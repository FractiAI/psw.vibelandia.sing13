...
describe('QUESTFEST latest-six ship blog', () => {
  ...
  it('does not let older notes outrank newer papers', () => {
    ...
    // Newest featured note (SNA/TCP-IP fractal moment · 2026-09-03) leads latest-six.
    expect(posts[0].published).toBe('2026-09-03');
    expect(posts[0].id).toBe('synthobs-ibm-sna-tcp-ip-gateway-fractal-moment-2026-09');
