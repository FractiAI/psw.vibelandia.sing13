...
describe('QUESTFEST latest-six ship blog', () => {
  ...
  it('does not let older notes outrank newer papers', () => {
    ...
    // Newest: Linear shadow fractal · Digit 4 · Consciousness Moat · Sovereign Velocity · Infinite Octave EGS Catalog · Pacing Paradox
    expect(posts[0].id).toBe('synthobs-linear-shadow-fractal-2026-09');
