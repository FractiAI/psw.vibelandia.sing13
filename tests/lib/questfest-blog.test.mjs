...
describe('QUESTFEST latest-six ship blog', () => {
  ...
  it('does not let older notes outrank newer papers', () => {
    ...
    // Newest featured notes: ISO same-day stamps (macro-protein · volumetric · protein) lead date-only 2026-09-05.
    expect(posts[0].published).toBe('2026-09-05T20:00:00Z');
    expect(posts[0].id).toBe('synthobs-macro-protein-work-engine-2026-09');
