...
describe('QUESTFEST latest-six ship blog', () => {
  ...
  it('does not let older notes outrank newer papers', () => {
    ...
    // Newest: Omniversal Time-Crystal · Self-Observing Genome · Generative Matrix · Tier C · Open empirical · Zero-Octave Y
    expect(posts[0].id).toBe('synthobs-omniversal-time-crystal-engine-egs-2026-09');
