...
describe('QUESTFEST latest-six ship blog', () => {
  ...
  it('does not let older notes outrank newer papers', () => {
    ...
    // Newest: Digit 4 recursive reach · Consciousness Moat · Sovereign Velocity · Infinite Octave EGS Catalog · Pacing Paradox · FractiSkills
    expect(posts[0].id).toBe('synthobs-digit4-recursive-reach-awareness-theater-2026-09');
